<?php /* Smarty version 2.6.14, created on 2015-08-28 11:43:24
         compiled from system/helps.tpl */ ?>
...
Ext.onReady(function() {
	...
	id:'panel_3',
	collapsible: false,
	html:"<div class='helpFAQ notopradius'><h4 class='innerRightTitle2'></h4><?php $_from = $this->_tpl_vars['content_2']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['content2item'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['content2item']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['content2']):
        $this->_foreach['content2item']['iteration']++;
?><ul class='newslist'><div class='helpFAQInfo'><h4><strong>问：</strong><?php echo $this->_tpl_vars['content2']['FAQ']; ?>
</h4><p><strong style='color:#0088CC;'>答：</strong>  <?php echo $this->_tpl_vars['content2']['answer']; ?>
</p></div></ul><?php endforeach; endif; unset($_from); ?></div>"
	});
	...
	var tab = new Ext.TabPanel({
        activeTab: <?php echo $this->_tpl_vars['page']; ?>
,
		width:750,
