<?php /* Smarty version 2.6.14, created on 2015-10-10 16:38:13
         compiled from order/orderprint_dzmy.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'string_format', 'order/orderprint_dzmy.tpl', 240, false),array('modifier', 'date_format', 'order/orderprint_dzmy.tpl', 483, false),array('modifier', 'count', 'order/orderprint_dzmy.tpl', 483, false),array('modifier', 'truncate', 'order/orderprint_dzmy.tpl', 6313, false),)), $this); ?>
<!--
<li><img src="index.php?model=login&action=Barcode&number=<?php echo $this->_tpl_vars['order']['order_sn']; ?>
&height=28"></li>
-->
<style type="text/css">
<!--
...
<?php if ($this->_tpl_vars['type'] == 1): ?><!-打印地址->
<div style="width:240mm;float:left;">
<?php $_from = $this->_tpl_vars['orders']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['orderitem'] = array('total' => count($_from), 'iteration' => 0);
   ...
   <div style="position:relative;left: 28px;top: 27px;">
    ...
    <div style="position:relative;left:28px;top:-8px; width:300px;height:140px; line-height:120%">
        <ul style="width:300px; font-size:16px">
            ...
            <li>
                <?php echo $this->_tpl_vars['order']['consignee']; ?>

            </li>
            <li>
                <?php echo $this->_tpl_vars['order']['street1']; ?>

                &nbsp;
                <?php echo $this->_tpl_vars['order']['street2']; ?>
            ...
            <li>
                ...
                ,
                <?php echo $this->_tpl_vars['order']['state']; ?>
            ...
            <li>
                <?php echo $this->_tpl_vars['order']['country']; ?>

            </li>
            <li>
                <?php echo $this->_tpl_vars['order']['tel']; ?>
                                    ...
                                    <tr>
                                        <td colspan="4" style="border-top:2px solid #000;">
                                            ...
                                            style="font-size:11px">
                                                ...
                                                <?php $this->assign('x', '0'); ?>
                                                <?php $_from = $this->_tpl_vars['order']['goodsarr']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['goodsitem'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['goodsitem']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['goods']):
        $this->_foreach['goodsitem']['iteration']++;
?>
                                                <?php $this->assign('x', $this->_tpl_vars['x']+$this->_tpl_vars['goods']['Declared_value']); ?>
                                                <tr>
                                                    <td colspan="2" height="20" style="border-right:2px solid #000;">&nbsp;
                                                        <span  contenteditable = "true"><?php echo $this->_tpl_vars['goods']['goods_qty']; ?>
&nbsp;X&nbsp;<?php echo $this->_tpl_vars['goods']['dec_name']; ?>
</span>
                                                    </td>
                                                    <td align="center"><span  contenteditable = "true">$
<?php echo ((is_array($_tmp=$this->_tpl_vars['goods']['Declared_value'])) ? $this->_run_mod_handler('string_format', true, $_tmp, "%.2f") : smarty_modifier_string_format($_tmp, "%.2f")); ?>
</span>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="border-top:2px solid #000;border-bottom:2px solid #000;" align="center">
                                                        ...
                                                        <br/>
                                                        <span contenteditable="true">
                                                            $<?php echo ((is_array($_tmp=$this->_tpl_vars['x'])) ? $this->_run_mod_handler('string_format', true, $_tmp, "%.2f") : smarty_modifier_string_format($_tmp, "%.2f")); ?>
                                    ...
                                    <tr>
                                        <td colspan="4">
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0" align="left" style="font-size:11px;">
                                              ...
                                              <tr>
                                                <td><?php echo $this->_tpl_vars['today']; ?>
</td>
                                              </tr>
                                            </table>
                                        </td>
...
<div <?php if (! ($this->_foreach['orderitem']['iteration'] == $this->_foreach['orderitem']['total']) && ! ($this->_foreach['orderitem']['iteration'] <= 1) && ( ($this->_foreach['orderitem']['iteration']-1)+1 ) % 4 == 0): ?>class="pagebreak"<?php endif; ?>></div>
<?php endforeach; endif; unset($_from); ?>
</div>

    
<?php elseif ($this->_tpl_vars['type'] == 224): ?><!--递四方的 10*10-->    
...
?>
    <div id="box"  class="pagebreak">
        <div class="first-row">
            ...
            <span class="country">
                 <?php if ($this->_tpl_vars['order']['CountryCode']): ?> <?php echo $this->_tpl_vars['order']['CountryCode']; ?>
 <?php else: ?> PE <?php endif; ?> &nbsp;<?php echo $this->_tpl_vars['order']['Cncountry']; ?>
        ...
        <div class="main-info">
            <table border="0" cellpadding="5" cellspacing="0" class="tab1">
                <tr>
                    ...
                    <td>
                        <p><b><?php echo $this->_tpl_vars['order']['consignee']; ?>
</b><br/>
                        <?php echo $this->_tpl_vars['order']['street1']; ?>
  <?php echo $this->_tpl_vars['order']['street2']; ?>
<br/>
...
<br/>
                        <?php echo $this->_tpl_vars['order']['country']; ?>
<br/>
                        <b><?php echo $this->_tpl_vars['order']['country']; ?>
</b>
                        </p>
                    </td>
                </tr>
            ...
            <table border="0" cellpadding="5" cellspacing="0" class="tab2">
                <tr>
                    ...
                    <td width="110px"><?php echo $this->_tpl_vars['order']['zipcode']; ?>
</td>
        ...
        <div class="bar-code">
            <b>R</b>
            <div style="text-align:center;"><img src="common/lib/barcodegen/html/image.php?filetype=PNG&dpi=72&scale=1&rotation=0&font_family=Arial.ttf&font_size=8&text=<?php echo $this->_tpl_vars['order']['track_no']; ?>
&thickness=30&start=NULL&code=BCGcode128"></div>
        </div>
        <div class="date"><b>[</b>7552200<b>]</b>&nbsp;Ref No：AVIPADMIN1659610&nbsp;</div>
        <div class="coding">CS:S4087&nbsp;&nbsp;SD:S2308(X009)<span><?php echo ((is_array($_tmp=time())) ? $this->_run_mod_handler('date_format', true, $_tmp, '%m-%d %H:%M:%S') : smarty_modifier_date_format($_tmp, '%m-%d %H:%M:%S')); ?>
&nbsp;&nbsp;<?php echo $this->_tpl_vars['key']+1; ?>
/<?php echo count($this->_tpl_vars['orders']); ?>
 </span>  </div>
        <div class="coding_s">
            <?php $_from = $this->_tpl_vars['order']['goodsarr']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['goodsitem'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['goodsitem']['total'] > 0):
...
&nbsp;*&nbsp;<?php echo $this->_tpl_vars['goods']['goods_qty']; ?>
...
<?php elseif ($this->_tpl_vars['type'] == 225): ?><!--递四方的2 10*10-->    
...
?>
    <div id="box"  class="pagebreak">
        <div class="first-row">
            ...
            <span class="country">
                 <?php if ($this->_tpl_vars['order']['CountryCode']): ?> <?php echo $this->_tpl_vars['order']['CountryCode']; ?>
 <?php else: ?> FR <?php endif; ?>  &nbsp;<?php echo $this->_tpl_vars['order']['Cncountry']; ?>
        ...
        <div class="main-info">
            <table border="0" cellpadding="5" cellspacing="0" class="tab1">
                <tr>
                    <td style="width:42px;"><strong>To</strong></td>
                    <td>
                        <p><?php echo $this->_tpl_vars['order']['consignee']; ?>
<br/>
                        <?php echo $this->_tpl_vars['order']['street1']; ?>
  <?php echo $this->_tpl_vars['order']['street2']; ?>
<br/>
...
<br/>
        ...
        <div class="bounce"><strong>退件单位 :</strong></div>
        <div class="bar-code">
            <div style="text-align:center;margin-top:10px;"><img src="common/lib/barcodegen/html/image.php?filetype=PNG&dpi=72&scale=1&rotation=0&font_family=Arial.ttf&font_size=8&text=<?php echo $this->_tpl_vars['order']['track_no']; ?>
&thickness=30&start=NULL&code=BCGcode128"></div>
        </div>
        <div class="date">[7551614]&nbsp;&nbsp;<?php echo ((is_array($_tmp=time())) ? $this->_run_mod_handler('date_format', true, $_tmp, '%Y-%m-%d %H:%M:%S') : smarty_modifier_date_format($_tmp, '%Y-%m-%d %H:%M:%S')); ?>
&nbsp;&nbsp;&nbsp;<?php echo $this->_tpl_vars['key']+1; ?>
/<?php echo count($this->_tpl_vars['orders']); ?>
 </div>
        <div class="coding">
...
<?php elseif ($this->_tpl_vars['type'] == 226): ?><!--燕邮宝(平邮)10*10-->
    <style>
* {
    margin:0;
    padding:0;
...
&thickness=30&start=NULL&code=BCGcode128"></div> 
        ...
        <div class="date">Y-POST-<?php echo $this->_tpl_vars['order']['Cncountry']; ?>
</div>
...
<br/>
            ...
            <div style='font-size:14px;line-height:14px;'><?php echo $this->_tpl_vars['order']['yw_logistic_no']; ?>
</div>
            <div><?php echo ((is_array($_tmp=time())) ? $this->_run_mod_handler('date_format', true, $_tmp, '%Y-%m-%d %H:%M:%S') : smarty_modifier_date_format($_tmp, '%Y-%m-%d %H:%M:%S')); ?>
&nbsp;&nbsp;&nbsp;<?php echo $this->_tpl_vars['key']+1; ?>
/<?php echo count($this->_tpl_vars['orders']); ?>
 </div>
        </div>
...
<?php elseif ($this->_tpl_vars['type'] == 227): ?><!--燕邮宝挂号 10*10-->
<style>
* {
    margin:0;
    padding:0;
...
<br/>
            ...
            <div><?php echo $this->_tpl_vars['order']['yw_logistic_no']; ?>
</div>
            <div><?php echo ((is_array($_tmp=time())) ? $this->_run_mod_handler('date_format', true, $_tmp, '%Y-%m-%d %H:%M:%S') : smarty_modifier_date_format($_tmp, '%Y-%m-%d %H:%M:%S')); ?>
&nbsp;&nbsp;&nbsp;<?php echo $this->_tpl_vars['key']+1; ?>
/<?php echo count($this->_tpl_vars['orders']); ?>
...
<?php elseif ($this->_tpl_vars['type'] == 222): ?><!--燕文北京(平邮)10*10-->
...
<div class="pagebreak">
        <div class='con_title clear'>
            <div class='con_title_s clear'>
                ...
                <span class='spans_1'>  <?php if ($this->_tpl_vars['order']['CountryCode']): ?> <?php echo $this->_tpl_vars['order']['CountryCode']; ?>
 <?php else: ?> US <?php endif; ?>  </span>
...
<br/>
                    ...
                    <p class='p2' >
                        phone:<?php echo $this->_tpl_vars['order']['tel']; ?>
 &nbsp;<?php echo $this->_tpl_vars['order']['Cncountry']; ?>
        ...
        <div class='con_center clear'>
                ...
                <div class='cen_s2'>
                    ...
                    <img src="common/lib/barcodegen/html/image.php?filetype=PNG&dpi=72&scale=1&rotation=0&font_family=Arial.ttf&font_size=10&text=<?php echo $this->_tpl_vars['order']['track_no']; ?>
&thickness=30&start=NULL&code=BCGcode128"/>
        ...
        <div class='con_foot clear'>
            ...
            <div class='con_foot_down'>
                ...
                <p class='p2'>
                    Sender`s signiture& Data Signed: 100000  <b><?php echo $this->_tpl_vars['order']['yw_no']; ?>
</b> <b>CN22</b>
                </P>
                <div class="coding" >
                <p><?php $_from = $this->_tpl_vars['order']['goodsarr']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['goodsitem'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['goodsitem']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['goods']):
        $this->_foreach['goodsitem']['iteration']++;
?>
...
<?php elseif ($this->_tpl_vars['type'] == 223): ?><!--中国邮政平常小包10*10-->
<style>
        ...
        <tr class='header'>
            <td class="header_left">
                <div class="header_left_top">
                    ...
                    <div class="header_left_top_country"> <?php if ($this->_tpl_vars['order']['CountryCode']): ?> <?php echo $this->_tpl_vars['order']['CountryCode']; ?>
 <?php else: ?> CA <?php endif; ?> </div>
                ...
                <div class="header_left_bottom">中邮深圳仓<br/><?php echo ((is_array($_tmp=time())) ? $this->_run_mod_handler('date_format', true, $_tmp, '%Y-%m-%d') : smarty_modifier_date_format($_tmp, '%Y-%m-%d')); ?>
&nbsp;&nbsp;<?php echo $this->_tpl_vars['key']+1; ?>
/<?php echo count($this->_tpl_vars['orders']); ?>
</div>
            </td>
            <td class="header_right" colspan="3">
                <div class="header_right_top">
                    <div style="text-align:center;margin-top:4px;height:50px;"> <img src="common/lib/barcodegen/html/image.php?filetype=PNG&dpi=72&scale=1&rotation=0&font_family=Arial.ttf&font_size=10&text=<?php echo $this->_tpl_vars['order']['track_no']; ?>
&thickness=30&start=NULL&code=BCGcode128"/> </div>
                    <div class="header_right_top_type" style='margin:2px 0 0;padding:0;'>untracked 平小包 &nbsp; &nbsp; &nbsp; 已验视</div>
                </div>
...
<br/>
                    ...
                    <div class="header_right_bottom_phoneaddr clear" >
                        <div class="header_right_bottom_phoneaddr_phone">
                            Phone:<span class="header_right_bottom_phoneaddr_phone_content" style='font-size:14px;'> <?php echo $this->_tpl_vars['order']['tel']; ?>
 </span>
                        </div>
                        <div class="header_right_bottom_phoneaddr_addr"><?php echo $this->_tpl_vars['order']['Cncountry']; ?>
 5</div>
                    </div>
                </div>
            </td>
...
&nbsp;*&nbsp;<?php echo $this->_tpl_vars['goods']['goods_qty']; ?>
 ...
 <?php elseif ($this->_tpl_vars['type'] == 230): ?><!--DHL小包（10*10）-->
            ...
            <table cellspacing='0' cellpadding='0' class='tab' style='overflow:hidden;'>
                ...
                <tr class='tr6'>
                    <td colspan='2'>
                        ...
                        <b><?php echo ((is_array($_tmp=time())) ? $this->_run_mod_handler('date_format', true, $_tmp, '%m-%d-%Y') : smarty_modifier_date_format($_tmp, '%m-%d-%Y')); ?>
&nbsp;&nbsp;<?php echo $this->_tpl_vars['key']+1; ?>
/<?php echo count($this->_tpl_vars['orders']); ?>
</b>
                    </td>
  ...
  <?php elseif ($this->_tpl_vars['type'] == 231): ?><!--DHL小包2（10*10）-->
...
/<?php echo count($this->_tpl_vars['orders']); ?>
 ...
 <?php elseif ($this->_tpl_vars['type'] == 232): ?><!--贝邮宝平邮（10*10）-->
        <style>
            *{margin:0;padding:0;}
        </style>
        ...
        <div style='width:370px;border:2px solid #7E7E7E;margin-bottom:10px;' class="pagebreak">
            <div style='height:44px;padding:2px;border-bottom:2px solid #7E7E7E;'>
                ...
                <div style='float:left;width:96px;text-align:right;font-size:14px;line-height:44px;padding-right:4px;'>
                    <p><strong>  <?php if ($this->_tpl_vars['order']['CountryCode']): ?> <?php echo $this->_tpl_vars['order']['CountryCode']; ?>
 <?php else: ?> DK <?php endif; ?>  <?php echo $this->_tpl_vars['order']['Cncountry']; ?>
</strong></p>
                </div>
            </div>
...
<br/>
                ...
                <tr>
                    <td style='border-bottom:2px solid #7E7E7E;border-right:2px solid #7E7E7E;font-size:10px;line-height:14px;padding-left:4px;height:14px;'><b>Zip:</b></td>
                    <td>
                        <span style='display:block;width:114px;height:14px;border-bottom:2px solid #7E7E7E;border-right:2px solid #7E7E7E;float:left;font-size:10px;padding-left:4px;line-height:14px;'><b> <?php echo $this->_tpl_vars['order']['zipcode']; ?>
</b></span>
                        <span style='border-bottom:2px solid #7E7E7E;border-right:2px solid #7E7E7E;font-size:10px;height:14px;line-height:14px;width:64px;padding-left:4px;display:block;float:left;'><b>Tel:</b></span>
                        <span style='width:106px;padding-left:4px;display:block;border-bottom:2px solid #7E7E7E;float:left;height:14px;line-height:14px;font-size:10px;'><b><?php echo $this->_tpl_vars['order']['tel']; ?>
</b></span>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan='2' style='height:50px;border-bottom:2px solid #7E7E7E;'>
                        ...
                        <div style='float:left;text-align:center;'>
                            <img src="common/lib/barcodegen/html/image.php?filetype=PNG&dpi=72&scale=2&rotation=0&font_family=Arial.ttf&font_size=10&text=<?php echo $this->_tpl_vars['order']['track_no']; ?>
&thickness=15&start=NULL&code=BCGcode128"/>
                        </div>
                    </td>
                </tr>
                <tr>
            ...
            <table cellspacing='0' cellpadding='0' style='width:370px;height:320px;' border='0'>
                ...
                <tr>
                    <td  style='font-size:10px;line-height:12px;border-right:2px solid #7E7E7E;padding-left:4px;;height:28px;vertical-align:top;'>
                        ...
                        <p><b><?php echo ((is_array($_tmp=time())) ? $this->_run_mod_handler('date_format', true, $_tmp, '%m-%d-%Y') : smarty_modifier_date_format($_tmp, '%m-%d-%Y')); ?>
&nbsp;&nbsp;<?php echo $this->_tpl_vars['key']+1; ?>
/<?php echo count($this->_tpl_vars['orders']); ?>
</b></p>
                    </td>
  ...
  <?php elseif ($this->_tpl_vars['type'] == 233): ?><!--贝邮宝挂号（10*10）-->
        <style>
            *{margin:0;padding:0;}
        </style>
...
/<?php echo count($this->_tpl_vars['orders']); ?>
 ...
 <?php elseif ($this->_tpl_vars['type'] == 237): ?><!--马来西亚平邮10*10-->
<?php $_from = $this->_tpl_vars['orders']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['orderitem'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['orderitem']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['key'] => $this->_tpl_vars['order']):
        $this->_foreach['orderitem']['iteration']++;
?>
        ...
        <div style="border:2px solid #666;height:366px;width:370px;padding:2px;margin-top:10px;" class="pagebreak">
            <div style='border:2px solid #666;height:100px;width:350px;margin:10px auto 20px;padding:5px;'>
                <p style='float:left;text-align:left;width:180px;font-size:13px;line-height:12px;padding:2px 4px;'>
                    If undeliverable,please return to:
                    Locked Bag No:1328
                    2002018708-03
                    Special Project Unit.
                    Pos Malaysia Intcrnational Hub
                    Pos Malaysia Bcrhad
                    Jalan KLIA l 64000 Malaysia
                </p>
                <p style='float:right;text-align:center;width:150px;font-size:15px;line-height:14px;border:2px solid #666;height:86px;padding:4px;'>
                    BAYARAN POS JELAS
                    POSTAGE PAID
                    POS MALAYSIA
                    INTERNATTONAL　AUB.
            ...
            <div style='height:224px;position:relative;'>
                <p style='font-size:14px;line-height:16px;padding:0px 2px;'>
                    TO：<strong>
                            <?php echo $this->_tpl_vars['order']['consignee']; ?>
<br/>
                            <?php echo $this->_tpl_vars['order']['street1']; ?>
...
<br/>
 ...
 &nbsp; <?php echo $this->_tpl_vars['order']['Cncountry']; ?>
<br/>
                            Zip:<?php echo $this->_tpl_vars['order']['zipcode']; ?>
  &nbsp; &nbsp; 
                            Tel:<?php echo $this->_tpl_vars['order']['tel']; ?>

                        </strong>
                </p>
                <div style='text-align:center;margin:10px 0px; height:50px;'>
                    <img src="common/lib/barcodegen/html/image.php?filetype=PNG&dpi=72&scale=2&rotation=0&font_family=Arial.ttf&font_size=10&text=<?php echo $this->_tpl_vars['order']['track_no']; ?>
&thickness=15&start=NULL&code=BCGcode128"/>
                </div>
                <p style='font-size:14px;line-height:16px;padding:0px 2px;margin-bottom:5px;'>              马来西亚小包平邮2016490202 Ref No:005643P11762749
                </p>
                <div style='font-size:12px;line-height:10px;padding:2px 4px;'>
                    <?php $_from = $this->_tpl_vars['order']['goodsarr']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['goodsitem'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['goodsitem']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['goods']):
        $this->_foreach['goodsitem']['iteration']++;
...
&nbsp;*&nbsp;<?php echo $this->_tpl_vars['goods']['goods_qty']; ?>
                ...
                <b style='position:absolute;top:0px;;right:4px;'> <?php echo $this->_tpl_vars['key']+1; ?>
/<?php echo count($this->_tpl_vars['orders']); ?>
 </b>
            </div>
            ...
            <table cellpadding='0' cellspacing='0' border='0' style='width:378px;height:374px;border:2px solid #666;margin-top:10px;' class="pagebreak">
                <tr>
                    <td colspan='3' style='font-size:14px;padding:2px 4px;border-bottom:2px solid #666;line-height:14px;'>
                        CUSTOMS<br/>
                        DECLARATION May be opened officially &nbsp; <strong> &nbsp; CN 23</strong>
                    </td>
                </tr>
                <tr>
                    <td colspan='3' style='font-size:14px;line-height:16px;border-bottom:2px solid #666;'>
                        Postal administration  <span style='display:inline-block;width:60px;height:16px;'></span>   Tick as appropriate
                    </td>
                </tr>
                <tr>
                    <td colspan='3' style='font-size:10px;line-height:14px;padding:4px 10px;border-bottom:2px solid #666;'>
                        <input type='checkbox' checked='checked' value=''/>Gift
                        <span style='display:inline-block;width:60px;height:14px;'>&nbsp;</span>
                        <input type='checkbox' value=''/>Commercial sample<br/>
                        <input type='checkbox' value=''/>Documents
                        <span style='display:inline-block;width:35px;height:14px;'>&nbsp;</span>
                        <input type='checkbox' value=''/>Other
                    </td>
                </tr>
                
                <tr style='text-align:center;line-height:16px;'>
                    <td style='font-size:8px;border-bottom:2px solid #666;border-right:2px solid #666;'>
                        Quantity and detailed description of contents
                    </td>
                    <td style='width:80px;font-size:9px;border-bottom:2px solid #666;border-right:2px solid #666;'>
                        Weight(in kg)
                    </td>
                    <td style='width:30px;font-size:12px;border-bottom:2px solid #666;'>
                        Value
                    </td>
                </tr>
                <tr style='font-size:12px;line-height:18px;height:24px;text-align:center;'>
                    <td style='border-bottom:2px solid #666;border-right:2px solid #666;'>
                        CASE
                    </td>
                    <td style='border-bottom:2px solid #666;border-right:2px solid #666;'>
                        0.043
                    </td>
                    <td style='border-bottom:2px solid #666;'>
                        5
                    </td>
                </tr>
                <tr style='font-size:12px;line-height:13px;text-align:left;'>
                    <td style='border-bottom:2px solid #666;border-right:2px solid #666;padding-left:3px;'>
                        For commercial items only If known, HS tarrif
                        number and country of origin of goods
                    </td>
                    <td style='border-bottom:2px solid #666;border-right:2px solid #666;padding-left:3px;'>
                        Total Weight(in kg)
                    </td>
                    <td style='border-bottom:2px solid #666;padding-left:3px;'>
                        Total Value(USD)
                    </td>
                </tr>
                <tr style='font-size:12px;line-height:16px;text-align:center;'>
                    <td style='border-bottom:2px solid #666;border-right:2px solid #666;'>
                        &nbsp;
                    </td>
                    <td style='border-bottom:2px solid #666;border-right:2px solid #666;'>
                ...
                <tr>
                    <td colspan='3' style='font-size:10px;line-height:11px;text-align:justify;padding:0 3px;'>
                        I, the undersigned, whose name and address are given on the item, certify that
                        the particulars given in this declaration are correct and that this item does not
                        contain any dangerous article or articles prohibited by legislation or by postal or
                        customs regulations.Date and sender's signature
                    </td>
                </tr>
                <tr>
                    <td colspan='3' style='text-align:center;font-size:20px;line-height:24px;'>
                        <strong style='margin-top:-20px;display:block;'>HLY XXWSM</strong>
                    </td>
                </tr>
            </table>
  ...
  <?php elseif ($this->_tpl_vars['type'] == 238): ?><!--马来西亚挂号10*10-->
<?php $_from = $this->_tpl_vars['orders']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['orderitem'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['orderitem']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['key'] => $this->_tpl_vars['order']):
        $this->_foreach['orderitem']['iteration']++;
...
<br/>
  ...
  &nbsp; &nbsp; 
                ...
                <div style='text-align:center;margin:10px 0px 3px;;border:2px solid #666;padding:4px 0px;position:relative;height:50px;'>
                    <strong style='position:absolute;font-size:38px;left:4px;top:0px;font-weight:bold;'>R</strong>
                    <img src="common/lib/barcodegen/html/image.php?filetype=PNG&dpi=72&scale=2&rotation=0&font_family=Arial.ttf&font_size=10&text=<?php echo $this->_tpl_vars['order']['track_no']; ?>
&thickness=15&start=NULL&code=BCGcode128"/>
                </div>
                <p style='font-size:13px;line-height:16px;padding:2px;border:2px solid #666;margin-bottom:5px;'>              马来西亚小包挂号2016458300 Ref No:69087604458569
                </p>
                <div style='font-size:12px;line-height:10px;padding:2px 4px;overflow:hidden;'>
                    <?php $_from = $this->_tpl_vars['order']['goodsarr']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['goodsitem'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['goodsitem']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['goods']):
        $this->_foreach['goodsitem']['iteration']++;
...
&nbsp;*&nbsp;<?php echo $this->_tpl_vars['goods']['goods_qty']; ?>
                ...
                <b style='position:absolute;top:4px;right:4px;'> <?php echo $this->_tpl_vars['key']+1; ?>
/<?php echo count($this->_tpl_vars['orders']); ?>
 </b>
            </div>
...
<?php endforeach; endif; unset($_from); ?>  
 ...
 <?php elseif ($this->_tpl_vars['type'] == 239): ?><!--中国邮政平邮小包10*10-->
<?php $_from = $this->_tpl_vars['orders']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['orderitem'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['orderitem']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['key'] => $this->_tpl_vars['order']):
        $this->_foreach['orderitem']['iteration']++;
?>
         <style> *{ margin:0; padding:0; } </style>
         <div style='width:374px;height:374px;border:2px solid #666;margin-bottom:10px;' class="pagebreak">
            <div style='height:152px;border-bottom:2px solid #666;'>
                <div style='height:32px;font-weight:bold;text-align:center;font-size:16px;float:left;width:374px;'>
                    <span style='float:left;width:140px;'> <img src="themes/default/images/emai0326.jpg"/> </span>
                    <span style='float:left;border-right:2px solid #666;width:120px;line-height:16px;'>
                        Small Packet<br/>
                        BYAIR
                    </span>
                    <span style='float:left;border-right:2px solid #666;width:50px;line-height:32px;'>GE</span>
                    <span style='float:left;width:60px;line-height:32px;'>DCPH</span>
                </div>
                
                <div style='width:146px;float:left;padding:4px 0px 2px 4px;height:114px;'>
                    <p style='border-bottom:2px solid #666;font-size:14px;line-height:20px;'>
                        <strong>From:</strong><br/>
                        中国广州市体育东路32
                        号苏红飞51620<br/>
                        Phone:
                    </p>
                    <p style='font-size:13px;line-height:15px;padding-top:2px;'>
                        自编号：  &nbsp; &nbsp; &nbsp; <?php echo $this->_tpl_vars['key']+1; ?>
/<?php echo count($this->_tpl_vars['orders']); ?>
 <br/>
                        69096588931614
                    </p>    
                </div>
                <div style='width:214px;float:left;font-size:15px;line-height:13px;border-top:2px solid #666;border-left:2px solid #666;padding:2px 4px;height:114px;'>
...
<br/>
 ...
 <br/> 
            ...
            <table cellspacing='0' cellpadding='0' border='0' style='width:374px;height:220px;'>
                <tr>
                    <td colspan='3' style='border-bottom:2px solid #666;height:50px;'>
                        <div style='text-align:center;position:relative;height:50px;'>
                            <b style='position:absolute;left:6px;top:20px;font-size:16px;line-height:18px;'>Untracked</b>
                            <img src="common/lib/barcodegen/html/image.php?filetype=PNG&dpi=72&scale=2&rotation=0&font_family=Arial.ttf&font_size=10&text=<?php echo $this->_tpl_vars['order']['track_no']; ?>
&thickness=15&start=NULL&code=BCGcode128"/>
                        </div>
                    </td>
                ...
                <tr>
                    <td style='font-size:11px;line-height:20px;border-right:2px solid #666;border-bottom:2px solid #666;padding-left:4px;'>
                        退件单位：广州邮政国际函件处理中心
                    </td>
                    <td colspan='2' style='font-size:11px;line-height:10px;border-bottom:2px solid #666;padding-left:2px;'>    
                        客户名称：<br/>
                        44190002305000
                    </td>
                </tr>
                <tr style='font-size:12px;line-height:16px;'>
                    <td style='border-right:2px solid #666;border-bottom:2px solid #666;padding-left:4px;'>
                        Description of contents
                    </td>
                    <td style='border-right:2px solid #666;border-bottom:2px solid #666;width:40px;text-align:center;'>    
                        KG
                    </td>
                    <td style='border-bottom:2px solid #666;text-align:center;font-size:11px;'>
                        Value(USD)
                    </td>
                </tr>
                <tr style='font-size:12px;line-height:16px;'>
                    <td style='border-right:2px solid #666;border-bottom:2px solid #666;text-align:center;'>
                        CASE
                    </td>
                    <td style='border-right:2px solid #666;border-bottom:2px solid #666;text-align:center;'>    
                        0.002
                    </td>
                    <td style='border-bottom:2px solid #666;text-align:center;'>
                        0.55
                    </td>
                </tr>
                <tr style='font-size:12px;line-height:16px;'>
                ...
                <tr style='height:27px;'>
                    <td colspan='3' style='font-size:10px;line-height:9px;padding-left:2px;height:27px;'>
                        I,the undersigned, certify the particulars given in this declaration are correct and
                        this item does not contain any dangerous articles prohibited by legislation or
                        customs regulations
                    </td>
                </tr>
                <tr style='font-size:14px;line-height:14px;padding-left:2px;height:14px;'>
                    <td colspan='2' >
                        <strong>Sender's signature Data Signed :</strong>
                    </td>
                    <td ><strong>CN22</strong></td>
                </tr>
                <tr >
                    <td colspan='3' style='font-size:12px;line-height:10px;padding-left:2px;padding-bottom:4px;'>
                         <?php $_from = $this->_tpl_vars['order']['goodsarr']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['goodsitem'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['goodsitem']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['goods']):
        $this->_foreach['goodsitem']['iteration']++;
...
<?php elseif ($this->_tpl_vars['type'] == 240): ?><!--中国邮政航空小包10*10-->
<?php $_from = $this->_tpl_vars['orders']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['orderitem'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['orderitem']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['key'] => $this->_tpl_vars['order']):
        $this->_foreach['orderitem']['iteration']++;
?> 
        <style> *{ margin:0; padding:0; } </style>
         ...
         <table cellspacing='0' cellpadding='0' border='0' style='width:374px;height:374px;border:2px solid #666;margin-top:10px;' class="pagebreak">
            <tr>
                <td colspan='3' style='border-bottom:2px solid #666;border-right:2px solid #666;font-size:12px;line-height:14px;padding-left:3px;'>FROM:中国广州市体育东路32号苏红飞51620</td>
                <td rowspan='2' style='border-bottom:2px solid #666;font-size:16px;text-align:center;'>已验视 MV</td>    
            </tr>
            <tr style='font-size:12px;line-height:14px;'>
                <td style='border-bottom:2px solid #666;border-right:2px solid #666;padding-left:3px;'>航空</td>
                <td style='border-bottom:2px solid #666;border-right:2px solid #666;padding-left:3px;'>GuangZhouChina</td>
                <td style='border-bottom:2px solid #666;border-right:2px solid #666;padding-left:3px;'>PAR AVION：</td>
            </tr>
            <tr style='font-size:11px;line-height:14px;'>
                <td style='border-bottom:2px solid #666;border-right:2px solid #666;padding-left:3px;'>小包邮件</td>
                <td style='border-bottom:2px solid #666;border-right:2px solid #666;padding-left:3px;'>单位：国际函件监管中心</td>
                <td style='border-bottom:2px solid #666;border-right:2px solid #666;padding-left:3px;'>PETIT PAQUET</td>
                <td style='border-bottom:2px solid #666;padding-left:3px;'>验视人：曾娥珍</td>    
            </tr>
            <tr style='font-size:12px;line-height:14px;'>
                <td colspan='3' style='border-bottom:2px solid #666;border-right:2px solid #666;padding-left:3px;'>协议客户：44010100176000</td>
                <td style='border-bottom:2px solid #666;text-align:center;font-weight:bold;'>DCPH</td>
            </tr>
            <tr>
                <td style='font-size:20px;text-align:right;font-weight:bold;vertical-align:top;padding-top:10px;'>To:</td>
                <td colspan='3' style='font-size:16px;line-height:15px;'>
                        <strong>                        
                        <?php echo $this->_tpl_vars['order']['consignee']; ?>
<br/>
                         <?php echo $this->_tpl_vars['order']['street1']; ?>
...
<br/>
 ...
 &nbsp; <?php echo $this->_tpl_vars['order']['Cncountry']; ?>
            ...
            <tr style='font-size:14px;line-height:16px;'>
                <td colspan='2' style='padding-left:3px;border-bottom:2px solid #666;'>Zip:<?php echo $this->_tpl_vars['order']['zipcode']; ?>
 </td>
                <td colspan='2' style='border-bottom:2px solid #666;'>Tel:<?php echo $this->_tpl_vars['order']['tel']; ?>
</td>
            </tr>
            <tr style='font-size:14px;line-height:16px;'>
                <td colspan='2' style='padding-left:3px;border-bottom:2px solid #666;'>退货单位:</td>
                <td colspan='2' style='border-bottom:2px solid #666;'>广州邮政国际函件处理中心</td>
            </tr>
            <tr>
                <td style='border-bottom:2px solid #666;font-size:40px;font-weight:bold;vertical-align:top;padding-top:10px;padding-left:6px;'>
                    R
                </td>
                <td colspan='3' style='text-align:center;border-bottom:2px solid #666;height:50px;'>
                    <img src="common/lib/barcodegen/html/image.php?filetype=PNG&dpi=72&scale=2&rotation=0&font_family=Arial.ttf&font_size=10&text=<?php echo $this->_tpl_vars['order']['track_no']; ?>
&thickness=15&start=NULL&code=BCGcode128"/>
                </td>
            </tr>
            <tr style='font-size:14px;line-height:13px;'>
                <td colspan='3' style='border-bottom:2px solid #666;padding-left:3px;'>
                    ID:2016470601 / Ref No:69167727803853
                </td>
                <td style='text-align:center;border-bottom:2px solid #666;'><?php echo $this->_tpl_vars['key']+1; ?>
/<?php echo count($this->_tpl_vars['orders']); ?>
</td>
            </tr>
            <tr>
                <td colspan='4' style='font-size:12px;line-height:11px;'>
                    <?php $_from = $this->_tpl_vars['order']['goodsarr']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['goodsitem'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['goodsitem']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['goods']):
        $this->_foreach['goodsitem']['iteration']++;
...
&nbsp;*&nbsp;<?php echo $this->_tpl_vars['goods']['goods_qty']; ?>
        ...
        <table cellpadding='0' cellspacing='0' border='0' style='border:2px solid #666;width:374px;height:374px;margin-top:10px;' class="pagebreak">
            <tr>
                <td colspan='3' style='height:36px;border-bottom:2px solid #666;'>
                    <div style='width:120px;float:left;text-align:center;'>
                        <img src='themes/default/images/emails0326.jpg' alt='80*80'/>
                    </div>
                    <p style='width:174px;float:left;font-size:16px;line-height:18px;text-align:center;'>
                        报关签条<br/>
                        CUSTOMS DECLARATION
                    </p>
                    <p style='float:left;width:76px;font-size:16px;line-height:18px;text-align:center;'>
                        邮2113<br/>
                        CN 22
                    </p>
                </td>
            ...
            <tr>
                <td colspan='3' style='border-bottom:2px solid #666;'>
                    <p style='width:170px;font-size:12px;line-height:14px;float:left;'>可以径行开拆</p>
                    <p style='font-size:12px;line-height:14px;float:left;'>May be opened officially</p>
                </td>
            </tr>
            <tr>
                <td style='border-bottom:2px solid #666;height:48px;border-right:2px solid #666;width:220px;text-align:center;'>
                    <p style='float:left;width:120px;font-size:12px;line-height:11px;border-right:2px solid #666;height:44px;padding:2px 0px;'>
                            邮件种类<br/>
                        Category of item<br/>
                        请在适当的内容前划<br/>
                            “ ╳ ”
                    </p>
                    <div style='float:left;font-size:12px;line-height:11px;height:44px;'>
                        <div style='border-bottom:2px solid #666;height:22px;'>
                            <p style='float:left;width:30px;border-right:2px solid #666;height:20px;line-height:20px;padding:1px 0px;'>X</p>
                            <p style='float:left;border-bottom:2px solid #666;height:20px;width:66px;padding:1px 0px;'>
                                礼品<br/>
                                Gift
                            </p>
                        </div>
                        <div style='height:24px;'>
                            <p style='float:left;width:30px;border-right:2px solid #666;height:22px;padding:1px 0px;'>&nbsp;</p>
                            <p style='float:left;height:22px;width:66px;padding:1px 0px;'>
                                文件<br/>
                                Documents
                            </p>
                        </div>
                ...
                <td colspan='2' style='border-bottom:2px solid #666;height:48px;font-size:12px;line-height:11px;text-align:center;'>
                    <div style='float:left;font-size:12px;line-height:11px;height:48px;'>
                        <div style='border-bottom:2px solid #666;height:22px;'>
                            <p style='float:left;width:30px;border-right:2px solid #666;height:20px;line-height:20px;padding:1px 0px;'>X</p>
                            <p style='float:left;border-bottom:2px solid #666;height:20px;width:116px;padding:1px 0px;'>
                                商品货样<br/>
                                Commercial Sample
                            </p>
                        </div>
                        <div style='height:24px;'>
                            <p style='float:left;width:30px;border-right:2px solid #666;height:22px;padding:1px 0px;'>&nbsp;</p>
                            <p style='float:left;height:22px;width:116px;padding:1px 0px;'>
                                其他<br/>
                                Other
                            </p>
                        </div>
            ...
            <tr style='font-size:12px;line-height:11px;'>
                <td style='width:214px;border-right:2px solid #666;border-bottom:2px solid #666;padding:0px 3px;'>
                    内件详细名称和数量<br/>
                    Quantity and detailed description of contents
                </td>
                <td style='border-right:2px solid #666;border-bottom:2px solid #666;text-align:center;'>
            ...
            <tr style='font-size:14px;line-height:16px;text-align:center;'>
                <td style='width:220px;border-right:2px solid #666;border-bottom:2px solid #666;'>
                    CASE
                </td>
                <td style='border-right:2px solid #666;border-bottom:2px solid #666;'>
                    0.002
                </td>
                <td style='border-bottom:2px solid #666;'>
                    USD2.65
            ...
            <tr style='font-size:11px;line-height:10px;'>
                <td style='width:214px;border-right:2px solid #666;border-bottom:2px solid #666;padding:0px 3px;'>
                    协调系统税则号列和货物原产国（只对商品邮件填写）
                    HS tariff number and country of origin of goods
                    (Forcommercial items only)
                </td>
                <td style='border-right:2px solid #666;border-bottom:2px solid #666;text-align:center;'>
                    总重量(千克)
                    Total Weight(kg)
            ...
            <tr>
                <td colspan='3' style='font-size:10px;line-height:9px;text-align:justify;padding:0px 3px;'>               我保证上述申报准确无误，本函件内未装寄法律或邮政和海关规章禁止寄递的任何危险物品
                    I,the undersigned ,certify that the particulars given in this declaration are correct and this item does not
                    containany dangerous articles prohibited by legislation or by postal or customers regulations
                </td>
            </tr>
            <tr>
                <td colspan='3' style='font-size:14px;line-height:16px;padding-left:3px;'>
                    寄件人签字Sender's signiture: <strong> Linda </strong>
                </td>
            </tr>
        </table>
...
<?php elseif ($this->_tpl_vars['type'] == 241): ?><!--中国邮政航空小包10*10-->
<?php $_from = $this->_tpl_vars['orders']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['orderitem'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['orderitem']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['key'] => $this->_tpl_vars['order']):
        $this->_foreach['orderitem']['iteration']++;
?> 
        <style> *{ margin:0; padding:0; } </style>
         ...
         <table cellspacing='0' cellpadding='0' border='0' style='width:374px;height:374px;border:2px solid #666;margin-top:10px;' class="pagebreak">
            <tr>
                <td colspan='4' style='height:36px;border-bottom:2px solid #666;'>
                    <div style='width:120px;float:left;text-align:center;'>
                        <img src='themes/default/images/emails0326.jpg' alt='80*80'/>
                    </div>
                    <p style='width:144px;float:left;font-size:14px;line-height:12px;text-align:center;padding-top:3px;height:36px;'>
                        航 &nbsp;空<br/>
                        Small &nbsp;Packef<br/>
                        BY &nbsp;AIR
                    </p>
                    <p style='float:left;width:106px;font-size:13px;line-height:18px;text-align:left;height:36px;padding-top:3px;'>
                        <strong>US22 <?php echo $this->_tpl_vars['order']['Cncountry']; ?>
 /</strong><br/>
                        <strong>50</strong>
                    </p>
                </td>
            ...
            <tr style='font-size:12px;line-height:14px;'>
                <td colspan='4' style='border-bottom:2px solid #666;padding-left:3px;'>协议客户：12000000062000 天津罗捷斯电子商务有限公司</td>
            </tr>
            <tr style='font-size:12px;line-height:14px;'>
                <td colspan='4' style='padding-left:3px;height:28px;'><b>From</b> Guorui Zhang No.699 Jinbei Road Dongli District Tianjin City</td>
            </tr>
            <tr style='font-size:12px;line-height:14px;'>
                <td colspan='2' style='border-bottom:2px solid #666;padding-left:3px;'>Zip:300300</td>
                <td colspan='2' style='border-bottom:2px solid #666;padding-left:100px;'>Tel:</td>
            </tr>
            <tr>
                <td style='font-size:20px;text-align:right;font-weight:bold;vertical-align:top;padding-top:10px;width:60px;'>To:</td>
                <td colspan='3' style='font-size:16px;line-height:15px;'>
                        <strong>                        
                        <?php echo $this->_tpl_vars['order']['consignee']; ?>
<br/>
...
<br/>
 ...
 &nbsp; <?php echo $this->_tpl_vars['order']['Cncountry']; ?>
            ...
            <tr style='font-size:14px;line-height:16px;'>
                ...
                <td colspan='2' style='border-bottom:2px solid #666;padding-left:50px;'>Tel: &nbsp;<?php echo $this->_tpl_vars['order']['tel']; ?>
</td>
            </tr>
            <tr style='font-size:14px;line-height:16px;'>
                <td colspan='2' style='padding-left:3px;border-bottom:2px solid #666;'>退货单位:</td>
                <td colspan='2' style='border-bottom:2px solid #666;padding-left:30px;'>天津集中收寄处理中心</td>
            </tr>
            <tr>
                <td colspan='4' style='text-align:center;border-bottom:2px solid #666;'>
                    <img src="common/lib/barcodegen/html/image.php?filetype=PNG&dpi=72&scale=2&rotation=0&font_family=Arial.ttf&font_size=10&text=<?php echo $this->_tpl_vars['order']['track_no']; ?>
&thickness=15&start=NULL&code=BCGcode128"/>
                </td>
            </tr>
            <tr style='font-size:14px;line-height:13px;'>
                <td colspan='3' style='border-bottom:2px solid #666;padding-left:3px;'>
                    ID:2017463319 / Ref No:69823169281035
                </td>
                <td style='text-align:center;border-bottom:2px solid #666;width:40px;'> <?php echo $this->_tpl_vars['key']+1; ?>
/<?php echo count($this->_tpl_vars['orders']); ?>
</td>
            </tr>
            <tr>
...
<?php elseif ($this->_tpl_vars['type'] == 234): ?><!--芬兰邮政经济小包10*10-->
<?php $_from = $this->_tpl_vars['orders']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['orderitem'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['orderitem']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['key'] => $this->_tpl_vars['order']):
        $this->_foreach['orderitem']['iteration']++;
...
&thickness=15&start=NULL&code=BCGcode128"/>
            ...
            <div style='height:170px;position:relative;border-bottom:2px solid #666;'>
                <span style='position:absolute;right:10px;top:2px;font-size:18px;font-weight:bold;'>  <?php if ($this->_tpl_vars['order']['CountryCode']): ?> <?php echo $this->_tpl_vars['order']['CountryCode']; ?>
 <?php else: ?> BY <?php endif; ?>  </span>
                <div>
                    <p style='font-size:16px;font-weight:bold;padding:2px 4px;line-height:16px;'>
                        To: <?php echo $this->_tpl_vars['order']['consignee']; ?>
<br/>
                         <?php echo $this->_tpl_vars['order']['street1']; ?>
 <?php echo $this->_tpl_vars['order']['street2']; ?>
<br/>
...
<br/>
            ...
            <div style='position:relative;padding:2px 4px;'>
                ...
                <span style='position:absolute;right:10px;top:2px;font-size:12px;'> <?php echo $this->_tpl_vars['key']+1; ?>
/<?php echo count($this->_tpl_vars['orders']); ?>
</span>
...
<?php endforeach; endif; unset($_from); ?>  
 ...
 <?php elseif ($this->_tpl_vars['type'] == 235): ?><!--E特快10*10-->
<?php $_from = $this->_tpl_vars['orders']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['orderitem'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['orderitem']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['key'] => $this->_tpl_vars['order']):
        $this->_foreach['orderitem']['iteration']++;
        ...
        <div style='width:370px;height:370px;border:2px solid #666;margin-bottom:10px;' class="pagebreak">
            ...
            <div style='height:72px;'>
                <div style='height:66px;width:192px;border-right:2px solid #666;border-bottom:2px solid #666;font-size:12px;line-height:13px;padding:2px 4px;float:left;'>
                    ...
                    CHINA    <span style='float:right;'><?php echo $this->_tpl_vars['key']+1; ?>
/<?php echo count($this->_tpl_vars['orders']); ?>
<span>
                </div>
...
<?php endforeach; endif; unset($_from); ?>  
  ...
  <?php elseif ($this->_tpl_vars['type'] == 236): ?><!--邮件详情单-->
<?php $_from = $this->_tpl_vars['orders']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['orderitem'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['orderitem']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['key'] => $this->_tpl_vars['order']):
        $this->_foreach['orderitem']['iteration']++;
?>
       ...
       <div style='margin-left:20px;float:left;'>
        <table class='tab1' style='width:370px;height:160px;border-top:2px solid #666;border-left:2px solid #666;' cellpadding='0' cellspacing='0' border='0'>
            <tr>
                ...
                <td style='font-size:12px;'> <?php echo ((is_array($_tmp=time())) ? $this->_run_mod_handler('date_format', true, $_tmp, '%m-%d-%Y') : smarty_modifier_date_format($_tmp, '%m-%d-%Y')); ?>
 </td>
            </tr>
            <tr>
    ...
    <div style='float:left;width:370px;height:350px;border:2px solid #666;border-left:1px solid #ccc;'>
        <div style='height:23px;font-size:14px;line-height:23px;text-align:center;border-bottom:1px solid #000;'>
            ...
            <p style='float:left;padding-left:6px;font-weight:bold;'> <?php echo $this->_tpl_vars['order']['consignee']; ?>
 </p>
        </div>
        <div style='height:17px;font-size:14px;line-height:17px;text-align:center;border-bottom:1px solid #000;'>
            ...
            <p style='float:left;padding-left:6px;'> <?php echo $this->_tpl_vars['order']['tel']; ?>
 </p>
        </div>
...
<br/>
            ...
            邮政编码/POST CODE:<span style='font-size:14px;font-weight:bold;'> <?php echo $this->_tpl_vars['order']['zipcode']; ?>
 </span>
            &nbsp;&nbsp;&nbsp;&nbsp;    
            Email:
        </div>
...
&thickness=15&start=NULL&code=BCGcode128"/>
    ...
    <div  style='height:10px;width:100%;clear:both;'<?php if (! ($this->_foreach['orderitem']['iteration'] == $this->_foreach['orderitem']['total']) && ! ($this->_foreach['orderitem']['iteration'] <= 1) && ( ($this->_foreach['orderitem']['iteration']-1)+1 ) % 3 == 0): ?>class="pagebreak"<?php endif; ?>></div>
    
<?php endforeach; endif; unset($_from); ?>  
 
 
 
<?php elseif ($this->_tpl_vars['type'] == 228): ?><!--香港小包（10*10）-->
<style>
*{margin:0;padding:0;}
.clear:after{content:".";height : 0;display:block;visibility:hidden;clear:both;}
.clear{zoom:1;}
...
<!--地址标签-->
    <div style="padding:0px;margin:0px;float:left;width:9.5cm;margin-left:2px;margin-top:5px;border:1px dashed #000;margin-bottom:10px;">
     <div style="padding:0px;margin:0px;height:0.2cm;width:8.8cm;overflow:hidden;text-align:center;font-size:7pt;word-wrap:break-word;border:none;">&nbsp; </div>
        ...
        <span style="padding:0px;margin:0px;float:right;margin-right:1.0cm;font-size:9pt;font-weight:600;"><?php echo $this->_tpl_vars['order']['order_sn']; ?>
</span>
            From: DZMY 
        </p>
       <p style="padding:0px;margin:0px;padding:0px 10px;font-size:8pt;line-height:16px;"></p>
       <p style="padding:0px;margin:0px;padding-left:10px;font-size:9pt;font-weight:600;line-height:20px;margin-top:1px;">Send To: <span style="padding:0px;margin:0px;font-weight:600;font-size:10pt;"><?php echo $this->_tpl_vars['order']['consignee']; ?>
</span></p>
        ...
        <p style="padding:0px;margin:0px;font-weight:600;font-size:10pt;"><?php echo $this->_tpl_vars['order']['street1']; ?>
&nbsp; <?php echo $this->_tpl_vars['order']['street2']; ?>
 </p>
        <p style="padding:0px;margin:0px;font-weight:600;margin-bottom:2px;font-size:10pt;"> <?php echo $this->_tpl_vars['order']['city']; ?>
,<?php if ($this->_tpl_vars['order']['state']):  echo $this->_tpl_vars['order']['state']; ?>
,<?php endif; ?>&nbsp;<?php echo $this->_tpl_vars['order']['zipcode']; ?>
</p>
        <p style="padding:0px;margin:0px;font-weight:600;font-size:9pt;margin-bottom:2px">
              <?php echo $this->_tpl_vars['order']['country']; ?>

            <span style="padding:0px;margin:0px;font-size:10pt">(<?php echo $this->_tpl_vars['order']['Cncountry']; ?>
)</span>
        ...
        <p style="padding:0px;margin:0px;font-size:9pt;">Tel: <?php echo $this->_tpl_vars['order']['tel']; ?>
</p>
        <p><img src="common/lib/barcodegen/html/image.php?filetype=PNG&dpi=72&scale=1&rotation=0&font_family=Arial.ttf&font_size=8&text=<?php echo $this->_tpl_vars['order']['track_no']; ?>
&thickness=30&start=NULL&code=BCGcode128"></p>
        ...
        <div  style='font-size:12px;text-align:right;'> <?php echo ((is_array($_tmp=time())) ? $this->_run_mod_handler('date_format', true, $_tmp, '%Y-%m-%d') : smarty_modifier_date_format($_tmp, '%Y-%m-%d')); ?>
&nbsp;&nbsp;<?php echo $this->_tpl_vars['key']+1; ?>
/<?php echo count($this->_tpl_vars['orders']); ?>
</div>
    </div>
...
<?php endforeach; endif; unset($_from); ?>  
 ...
 <?php elseif ($this->_tpl_vars['type'] == 229): ?><!--香港小包2（10*10）-->
<?php $_from = $this->_tpl_vars['orders']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['orderitem'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['orderitem']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['key'] => $this->_tpl_vars['order']):
        $this->_foreach['orderitem']['iteration']++;
...
<?php elseif ($this->_tpl_vars['type'] == 131): ?><!--香港邮政小包(平邮)10*10-->
<?php $_from = $this->_tpl_vars['orders']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['orderitem'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['orderitem']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['order']):
        $this->_foreach['orderitem']['iteration']++;
...
<div style="padding:0px;margin:0px;height:6.76cm;width:8.4cm;margin-left:2px;margin-top:5px;overflow:hidden;border:1px dashed #000;">
    ...
    <div >
        ...
        <li style="clear:left;font-size:18px;margin-top:4px"><b>TO:<?php echo $this->_tpl_vars['order']['consignee']; ?>
</b></li>
        <li style="font-size:16px;"><b><?php echo $this->_tpl_vars['order']['street1']; ?>
  <?php echo $this->_tpl_vars['order']['street2']; ?>
</b></li>
        <li style="font-size:16px;"><b><?php echo $this->_tpl_vars['order']['city']; ?>
,<?php echo $this->_tpl_vars['order']['state']; ?>
,<?php echo $this->_tpl_vars['order']['zipcode']; ?>
</b></li>
        ...
        <b><?php echo $this->_tpl_vars['order']['tel']; ?>
</b></li>
        <li><img src="index.php?model=login&action=Barcode&number=<?php echo $this->_tpl_vars['order']['order_sn']; ?>
&height=50&type=0"></li>
        <li style="font-size:12px;margin-top:-20px;letter-spacing:4px;width:210px"><center>*<?php echo $this->_tpl_vars['order']['order_sn']; ?>
*</center><br/></li>
        <li><span style="font-size:12px;"><?php echo $this->_tpl_vars['order']['total']; ?>
---
        <?php $_from = $this->_tpl_vars['order']['goodsarr']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach["goodsitem}"] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach["goodsitem}"]['total'] > 0):
    foreach ($_from as $this->_tpl_vars['goods']):
        $this->_foreach["goodsitem}"]['iteration']++;
?>
        <?php echo $this->_tpl_vars['goods']['goods_sn'];  if ($this->_tpl_vars['goods']['goods_qty'] > 1): ?>&<?php echo $this->_tpl_vars['goods']['goods_qty'];  endif; ?>,
        <?php endforeach; endif; unset($_from); ?></span>
        <?php if ($this->_tpl_vars['order']['note']): ?><br><?php echo $this->_tpl_vars['order']['note'];  endif; ?>
        </li>
        </ul>
        </div>
    </div>
...
<?php echo $this->_tpl_vars['goods']['dec_name']; ?>
&nbsp;&nbsp;<?php echo $this->_tpl_vars['goods']['goods_qty']; ?>
...
<?php endforeach; endif; unset($_from);  elseif ($this->_tpl_vars['type'] == 154): ?><!--香港邮政小包(平邮)A4-->
<?php $_from = $this->_tpl_vars['orders']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['orderitem'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['orderitem']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['order']):
        $this->_foreach['orderitem']['iteration']++;
?>
  <div style="padding:0px;margin:0px;width: 9.7cm;"  <?php if (($this->_foreach['orderitem']['iteration'] == $this->_foreach['orderitem']['total'])):  else: ?>class="pagebreak"<?php endif; ?>>
...
<div style="padding:0px;margin:0px;float:left;height:6.76cm;width:8.4cm;margin-left:2px;margin-top:5px;display:inline;overflow:hidden;border:1px dashed #000;">
                 <div style="padding:0px;margin:0px;height:0.2cm;width:8.8cm;overflow:hidden;text-align:center;font-size:7pt;word-wrap:break-word;border:0;">&nbsp; </div>
                     <p style="padding:0px;margin:0px;padding-left:10px;font-size:9pt;font-weight:600;padding-top:3px;"><span style="padding:0px;margin:0px;float:right;margin-right:1.0cm;font-size:9pt;font-weight:600;"><?php echo $this->_tpl_vars['order']['order_sn']; ?>
</span>From: <?php echo $this->_tpl_vars['params']['Contact']; ?>
 </p>
                                       <p style="padding:0px;margin:0px;padding:0px 10px;font-size:8pt;line-height:16px;"></p>
                                       <p style="padding:0px;margin:0px;padding-left:10px;font-size:9pt;font-weight:600;line-height:20px;margin-top:1px;">Send To: <span style="padding:0px;margin:0px;font-weight:600;font-size:10pt;"><?php echo $this->_tpl_vars['order']['consignee']; ?>
</span></p>
...
,<?php endif; ?>&nbsp;<?php echo $this->_tpl_vars['order']['zipcode']; ?>
                ...
                <li><img src="index.php?model=login&action=Barcode&number=<?php echo $this->_tpl_vars['order']['track_no']; ?>
&height=40"></li>
    <center style="font-size:13px;margin-top:-20px;" >*<?php echo $this->_tpl_vars['order']['track_no']; ?>
*</center>
...
<td valign="middle" align="center" style="border:1px solid #000;border-top:0;border-bottom:0; border-right:0;border-collapse:collapse;    overflow:hidden;font-family:arial;padding:0px;margin:0px;">
<font style="padding:0px;margin:0px;font-size:8pt; ">
toy 玩具&nbsp;*&nbsp;<?php echo $this->_tpl_vars['goods']['goods_qty']; ?>
...
<?php endforeach; endif; unset($_from);  elseif ($this->_tpl_vars['type'] == 153): ?><!--香港邮政小包(挂号)A4-->
<?php $_from = $this->_tpl_vars['orders']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['orderitem'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['orderitem']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['order']):
        $this->_foreach['orderitem']['iteration']++;
...
<br>
            ...
            <tr>
                ...
                <U>SHIP TO:&nbsp;</U> <b style="font-size: 12px"><?php echo $this->_tpl_vars['order']['consignee']; ?>
</b> 
                <br>
                <font style="font-size:12px">
           <?php echo $this->_tpl_vars['order']['street1']; ?>

<br><?php echo $this->_tpl_vars['order']['city']; ?>
, <?php echo $this->_tpl_vars['order']['state']; ?>
, <?php echo $this->_tpl_vars['order']['zipcode']; ?>

<br><?php echo $this->_tpl_vars['order']['country']; ?>
<br>
      </font>
        <?php echo $this->_tpl_vars['order']['country']; ?>
&nbsp;(<?php echo $this->_tpl_vars['order']['Cncountry']; ?>
...
*
                            ...
                            <tr>
                                <td colspan="2">
                            <img src="index.php?model=login&action=Barcode&number=<?php echo $this->_tpl_vars['order']['order_sn']; ?>
&height=35">
...
X <?php echo $this->_tpl_vars['goods']['goods_qty']; ?>
...
<?php echo ((is_array($_tmp=$this->_tpl_vars['goods']['vargoods_price'])) ? $this->_run_mod_handler('string_format', true, $_tmp, "%.2f") : smarty_modifier_string_format($_tmp, "%.2f")); ?>
...
<div id=C63><span class=cn2>$<?php echo ((is_array($_tmp=$this->_tpl_vars['goods']['vargoods_price']*$this->_tpl_vars['goods']['goods_qty'])) ? $this->_run_mod_handler('string_format', true, $_tmp, "%.2f") : smarty_modifier_string_format($_tmp, "%.2f")); ?>
</span></div>
</DIV>
<DIV id=C7>
...
<div <?php if (! ($this->_foreach['orderitem']['iteration'] == $this->_foreach['orderitem']['total']) && ! ($this->_foreach['orderitem']['iteration'] <= 1) && ( ($this->_foreach['orderitem']['iteration']-1)+1 ) % 3 == 0): ?>class="pagebreak"<?php endif; ?>></div>
<?php endforeach; endif; unset($_from);  elseif ($this->_tpl_vars['type'] == 132): ?><!--香港邮政小包(挂号)10*10-->
<?php $_from = $this->_tpl_vars['orders']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['orderitem'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['orderitem']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['order']):
        $this->_foreach['orderitem']['iteration']++;
...
<tr style="padding:0px;margin:0px;border-left:0;border-right:0;">
<td valign="middle" align="center" style="border:1px solid #000;border-top:0;border-bottom:0; border-right:0;border-collapse:collapse;    overflow:hidden;font-family:arial;padding:0px;margin:0px;">
<font style="padding:0px;margin:0px;font-size:8pt; "><?php echo $this->_tpl_vars['goods']['dec_name']; ?>
&nbsp;*&nbsp;<?php echo $this->_tpl_vars['goods']['goods_qty']; ?>
</font></td>
<td valign="middle" align="center" style=" border:1px solid #000;border-collapse:collapse;    overflow:hidden;font-family:arial;border-top:0;border-bottom:0">
<font style="padding:0px;margin:0px;font-size:8pt"><span  contenteditable = "true"></span>
...
<td valign="middle" align="center" style="border-collapse:collapse;overflow:hidden;font-family:arial;padding:0px;margin:0px; border:1px solid #000;border-top:0;border-bottom:0; border-left:0"><font style="padding:0px;margin:0px;font-size:8pt;"><span  contenteditable = "true"><?php echo $this->_tpl_vars['goods']['Declared_value']; ?>
</span>
</font>
</td>
</tr>
<?php endforeach; endif; unset($_from); ?>
           ...
           <td  valign="top" align="center" style="border:1px solid #000;padding:0px;margin:0px;width:1.4cm;">(6)總重量
<br />Total weight<br />(公斤 kg)<br /><br /><font style="padding:0px;margin:0px;font-size:8pt"><span  contenteditable = "true">0.1</span></font></td><td  valign="top" align="center" style="border:1px solid #000;border-left:0;">(7)總共價值<br />Total Value<br /><br /><br /><font style="padding:0px;margin:0px;font-size:8pt"><span  contenteditable = "true"><?php echo $this->_tpl_vars['order']['vartotalprice']; ?>
</span></font></td>
           </tr>
...
<?php endforeach; endif; unset($_from);  elseif ($this->_tpl_vars['type'] == 158): ?><!-- 中国邮政小包（挂号）10*10 -->
<?php $_from = $this->_tpl_vars['orders']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['orderitem'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['orderitem']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['order']):
        $this->_foreach['orderitem']['iteration']++;
...
<div style="height:10px"></div>
<ul>
<li style="font-size:20;margin-top:4px"><b>TO:<?php echo $this->_tpl_vars['order']['consignee']; ?>
</b></li>
<li style="font-size:20px;"><b><?php echo $this->_tpl_vars['order']['street1']; ?>
  <?php echo $this->_tpl_vars['order']['street2']; ?>
</b></li>
<li style="font-size:20px;"><b><?php echo $this->_tpl_vars['order']['city']; ?>
,<?php echo $this->_tpl_vars['order']['state']; ?>
,<?php echo $this->_tpl_vars['order']['zipcode']; ?>
</b></li>
...
if ($this->_foreach['goodsitem']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['goods']):
        $this->_foreach['goodsitem']['iteration']++;
?>
<b style="font-size:14px"><?php echo $this->_tpl_vars['goods']['goods_sn']; ?>
</b>&nbsp;&nbsp;&nbsp;&nbsp;
 <?php endforeach; endif; unset($_from); ?>
</li>
</ul>
...
&nbsp;*&nbsp;<?php echo $this->_tpl_vars['goods']['goods_qty']; ?>
                        ...
                        <td style="padding:2px;    border-right:1px solid #000;       border-collapse:collapse;
                        overflow:hidden;padding:0px;margin:0px;width:1.5cm;font-size:6pt;text-align:center;">
                            <span  contenteditable = "true"><?php echo $this->_tpl_vars['goods']['Declared_value']; ?>
</span>
                        </td>
                    </tr>
            <?php endforeach; endif; unset($_from); ?>
...
<?php endforeach; endif; unset($_from);  elseif ($this->_tpl_vars['type'] == 160): ?><!-- 中国邮政小包（平邮）10*10-->
<?php $_from = $this->_tpl_vars['orders']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['orderitem'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['orderitem']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['order']):
        $this->_foreach['orderitem']['iteration']++;
?>
 <DIV style="PADDING-BOTTOM: 0px; MARGIN: 0px; PADDING-LEFT: 0px;PADDING-RIGHT: 0px; PADDING-TOP: 0px"  <?php if (($this->_foreach['orderitem']['iteration'] == $this->_foreach['orderitem']['total'])):  else: ?>class="pagebreak"<?php endif; ?>>
    <div style="width:8cm">
        <!--地址标签-->
            <div style=" border:1px dashed #000;padding:0px;margin:0px;height:7.8cm;width:7.9cm;margin-left:2px;margin-top:5px;">
                ...
                <p style="padding:0px;margin:0px;padding:0 5px;font-size:9pt;font-weight:600;padding-top:3px;">
                    From: <?php echo $this->_tpl_vars['params']['Contact']; ?>

                </p>
                <p style="padding:0px;margin:0px;padding:0px 5px;font-size:8pt;line-height:16px;">
                    <?php echo $this->_tpl_vars['params']['Company']; ?>

&nbsp;<?php echo $this->_tpl_vars['params']['Street']; ?>
,<?php echo $this->_tpl_vars['params']['City']; ?>

,<?php echo $this->_tpl_vars['params']['Province']; ?>
<br>
<?php echo $this->_tpl_vars['params']['Country']; ?>
&nbsp;<?php echo $this->_tpl_vars['params']['Postcode']; ?>
...
,<?php endif; ?> &nbsp;<?php echo $this->_tpl_vars['order']['zipcode']; ?>
                    ...
                    <li><img src="index.php?model=login&action=Barcode&number=<?php echo $this->_tpl_vars['order']['order_sn']; ?>
&height=50"></li>
 <center style="width:206px;margin-top:-20px;letter-spacing:4px;font-size:14px">*<?php echo $this->_tpl_vars['order']['order_sn']; ?>
*</center>
                    </div>
                </div>
            </div>
...
<?php endforeach; endif; unset($_from);  elseif ($this->_tpl_vars['type'] == 155): ?><!--新加坡邮政小包(挂号)-->
<?php $_from = $this->_tpl_vars['orders']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['orderitem'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['orderitem']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['order']):
        $this->_foreach['orderitem']['iteration']++;
?>
   <DIV style="PADDING-BOTTOM: 0px; MARGIN: 0px; PADDING-LEFT: 0px; WIDTH:19cm; PADDING-RIGHT: 0px; PADDING-TOP: 0px"  <?php if (($this->_foreach['orderitem']['iteration'] == $this->_foreach['orderitem']['total'])):  else: ?>class="pagebreak"<?php endif; ?>>
...
<?php echo ((is_array($_tmp=$this->_tpl_vars['goods']['vargoods_price'])) ? $this->_run_mod_handler('string_format', true, $_tmp, "%.2f") : smarty_modifier_string_format($_tmp, "%.2f")); ?>
    ...
    overflow:hidden;">
                            ...
                            <br/>
                            <br/>
                            &nbsp;&nbsp;<span  contenteditable = "true">$<?php echo ((is_array($_tmp=$this->_tpl_vars['order']['vartotalprice'])) ? $this->_run_mod_handler('string_format', true, $_tmp, "%.2f") : smarty_modifier_string_format($_tmp, "%.2f")); ?>
</span>
                        </td>
                    </tr>
                    <tr>
            ...
            <div style="padding:0px;margin:0px;font-family:arial;height:70%;width:100%;position: relative;">
                <div style="padding:0px;margin:0px;font-family:arial;width:58%;float:left;margin-top:0.1cm;padding-left:5px;">
                   ...
                   <div style="padding:0px;margin:0px;font-family:arial;width:8cm;word-wrap: break-word; word-break:break-all;position:absolute;">
                    ...
                    <div style="padding:0px;margin:0px;font-family:arial;float:left;width:7cm;" ><?php echo $this->_tpl_vars['order']['consignee']; ?>
</div>
                    <div style="padding:0px;margin:0px;font-family:arial;clear:left;padding-left:30px;font-weight:600;"> <?php echo $this->_tpl_vars['order']['street1']; ?>
&nbsp; <?php echo $this->_tpl_vars['order']['street2']; ?>
 </div>
                    <div style="padding:0px;margin:0px;font-family:arial;padding-left:30px;"><?php echo $this->_tpl_vars['order']['city']; ?>
,<?php if ($this->_tpl_vars['order']['state']):  echo $this->_tpl_vars['order']['state']; ?>
,<?php endif; ?>&nbsp;<?php echo $this->_tpl_vars['order']['zipcode']; ?>
</div>
                    <div style="padding:0px;margin:0px;font-family:arial;padding-left:30px;"><?php echo $this->_tpl_vars['order']['tel']; ?>
</div>
                    <div style="padding:0px;margin:0px;font-family:arial;padding-left:30px;"><?php echo $this->_tpl_vars['order']['country']; ?>
</div>
                </div>
                </div>
            ...
            <div>
                <div style="padding:0px;margin:0px;font-family:arial;float:left;width:56%;border:1px solid #000;"><center>
                    ...
                    <div>
                         <center><img src="index.php?model=login&action=Barcode&number=<?php echo $this->_tpl_vars['order']['track_no']; ?>
&height=40"></center>
                          <center style="font-size:13px;margin-top:-20px;" >*<?php echo $this->_tpl_vars['order']['track_no']; ?>
*</center>
                    </div>
...
<?php endforeach; endif; unset($_from);  elseif ($this->_tpl_vars['type'] == 156): ?><!--新加坡邮政小包(平邮)-->
<?php $_from = $this->_tpl_vars['orders']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['orderitem'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['orderitem']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['order']):
        $this->_foreach['orderitem']['iteration']++;
...
<?php echo ((is_array($_tmp=$this->_tpl_vars['goods']['vargoods_price'])) ? $this->_run_mod_handler('string_format', true, $_tmp, "%.2f") : smarty_modifier_string_format($_tmp, "%.2f")); ?>
    ...
    border-collapse:collapse;
    overflow:hidden;">Total Value<br/>&nbsp;&nbsp;<br/><br/>&nbsp;&nbsp;<span  contenteditable = "true">$<?php echo ((is_array($_tmp=$this->_tpl_vars['order']['vartotalprice'])) ? $this->_run_mod_handler('string_format', true, $_tmp, "%.2f") : smarty_modifier_string_format($_tmp, "%.2f")); ?>
</span></td>
                    </tr>
                    <tr>
                        <td colspan="3" style="border:1px solid #000;
...
,<?php endif; ?>&nbsp;<?php echo $this->_tpl_vars['order']['zipcode']; ?>
            ...
            <div style="padding:0px;margin:0px;font-family:arial;float:left;margin-top:0.1cm;position:absolute;left:170px">
                ...
                <div>Ref:<?php echo $this->_tpl_vars['order']['track_no']; ?>
</div>
...
&height=40"></li>
        ...
        <div>
            ...
            <div style="padding:0px;margin:0px;font-family:arial;float:left;padding-left:20px;">
                ...
                <div style="padding:0px;margin:0px;font-family:arial;margin-top:15px;padding-left:220px;font-size:10px;"><?php echo $this->_tpl_vars['order']['order_sn']; ?>
</div>
            </div>
        </div>
</div>
...
<?php endforeach; endif; unset($_from);  elseif ($this->_tpl_vars['type'] == 151): ?><!--瑞士邮政小包（挂号）-->
<?php $_from = $this->_tpl_vars['orders']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['orderitem'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['orderitem']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['order']):
        $this->_foreach['orderitem']['iteration']++;
...
&nbsp;<?php if ($this->_tpl_vars['order']['state']):  echo $this->_tpl_vars['order']['state']; ?>
&nbsp;<?php endif; ?></p>
                    <p style="padding:0px;margin:0px;font-weight:600;margin-bottom:2px;font-size:10pt;">     <?php echo $this->_tpl_vars['order']['zipcode']; ?>
...
<?php endforeach; endif; unset($_from);  elseif ($this->_tpl_vars['type'] == 152): ?><!--瑞士邮政小包（平邮）-->
<?php $_from = $this->_tpl_vars['orders']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['orderitem'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['orderitem']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['order']):
        $this->_foreach['orderitem']['iteration']++;
...
<?php endforeach; endif; unset($_from); ?>
                            <tr style="padding:0px;margin:0px;height:1cm;border-left:0;border-right:0;">
                                ...
                                <td valign="top" align="center" style="border:1px solid #000;padding:0px;margin:0px;border-left:0;border-right:0;">
                                    ...
                                    <br />
                                    <br />
                                    <font style="padding:0px;margin:0px;font-size:8pt"><span  contenteditable = "true">$<?php echo ((is_array($_tmp=$this->_tpl_vars['order']['vartotalprice'])) ? $this->_run_mod_handler('string_format', true, $_tmp, "%.2f") : smarty_modifier_string_format($_tmp, "%.2f")); ?>
</span>
                                    </font>
                                </td>
                            </tr>
    ...
    <?php endforeach; endif; unset($_from);  elseif ($this->_tpl_vars['type'] == 2): ?><!-打印拣货信息->
<?php $_from = $this->_tpl_vars['orders']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['orderitem'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['orderitem']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['order']):
        $this->_foreach['orderitem']['iteration']++;
?>
<div style="border-bottom:dotted;width:450px;height:150px" <?php if (($this->_foreach['orderitem']['iteration'] == $this->_foreach['orderitem']['total'])):  else: ?>class="pagebreak"<?php endif; ?>>
<ul>
<li><span class="STYLE1">*<?php if ($this->_tpl_vars['type'] == 2):  echo $this->_tpl_vars['order']['order_sn'];  else:  echo $this->_tpl_vars['order']['track_no'];  endif; ?>*</span></li>
<li><?php echo $this->_tpl_vars['order']['good_printstr']; ?>
</li>
<?php if ($this->_tpl_vars['order']['note']): ?><li>备注:<?php echo $this->_tpl_vars['order']['note']; ?>
</li><?php endif; ?>
<li><br></li>
</ul>
</div>
<?php endforeach; endif; unset($_from);  elseif ($this->_tpl_vars['type'] == 3): ?><!-打印商业invoice->
<?php $_from = $this->_tpl_vars['orders']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['orderitem'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['orderitem']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['order']):
        $this->_foreach['orderitem']['iteration']++;
?>
<div <?php if (($this->_foreach['orderitem']['iteration'] == $this->_foreach['orderitem']['total'])):  else: ?>class="pagebreak"<?php endif; ?>>
<table width="792" height="938" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000">
  ...
  <tr height="18">
    ...
    </strong><?php echo $this->_tpl_vars['today']; ?>
</td>
  </tr>
...
<?php echo $this->_tpl_vars['order']['consignee']; ?>
<br><?php echo $this->_tpl_vars['order']['street1']; ?>
  <?php echo $this->_tpl_vars['order']['street2']; ?>
<br><?php echo $this->_tpl_vars['order']['city']; ?>
,<?php echo $this->_tpl_vars['order']['state']; ?>
,<?php echo $this->_tpl_vars['order']['zipcode']; ?>
<br><br><?php echo $this->_tpl_vars['order']['country']; ?>
</td>
  </tr>
  <tr height="54">
    ...
    <td colspan="3" bgcolor="#FFFF00"><?php echo $this->_tpl_vars['order']['tel']; ?>
</td>
  </tr>
  <tr height="50">
  ...
  </strong>   <?php echo $this->_tpl_vars['order']['country']; ?>
</td>
  </tr>
  <tr height="38">
...
?>
  <tr height="42">
    ...
    <td><?php echo $this->_tpl_vars['goods']['goods_sn']; ?>
</td>
    <td><?php echo $this->_tpl_vars['goods']['goods_qty']; ?>
</td>
    <td>$<?php echo ((is_array($_tmp=$this->_tpl_vars['goods']['vargoods_price'])) ? $this->_run_mod_handler('string_format', true, $_tmp, "%.2f") : smarty_modifier_string_format($_tmp, "%.2f")); ?>
 </td>
    <td colspan="2">$<?php echo ((is_array($_tmp=$this->_tpl_vars['goods']['vargoods_price']*$this->_tpl_vars['goods']['goods_qty'])) ? $this->_run_mod_handler('string_format', true, $_tmp, "%.2f") : smarty_modifier_string_format($_tmp, "%.2f")); ?>
</td>
  </tr>
  <?php endforeach; endif; unset($_from); ?>
  <tr height="30">
    <td colspan="3" height="59"><strong>Total No. of pkgs</strong></td>
    <td width="235"><?php echo $this->_tpl_vars['order']['total']; ?>
</td>
    <td colspan="2"><div align="center"><strong>Total    Inv.Value</strong></div></td>
    <td colspan="3">$<?php echo ((is_array($_tmp=$this->_tpl_vars['order']['vartotalprice'])) ? $this->_run_mod_handler('string_format', true, $_tmp, "%.2f") : smarty_modifier_string_format($_tmp, "%.2f")); ?>
</td>
  </tr>
...
<?php endforeach; endif; unset($_from);  elseif ($this->_tpl_vars['type'] == 9): ?><!-打印形式invoice->
<?php $_from = $this->_tpl_vars['orders']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['orderitem'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['orderitem']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['order']):
        $this->_foreach['orderitem']['iteration']++;
...
?>
  <tr height="42">
    ...
    <td>$<?php echo $this->_tpl_vars['goods']['goods_price']; ?>
 </td>
    <td colspan="2">$<?php echo $this->_tpl_vars['goods']['goods_price']*$this->_tpl_vars['goods']['goods_qty']; ?>
</td>
  </tr>
  <?php endforeach; endif; unset($_from); ?>
  <tr height="30">
    ...
    <td colspan="2"><div align="center"><strong>Total    Inv.Value</strong></div></td>
    <td colspan="3">$<?php echo $this->_tpl_vars['order']['totalprice']; ?>
</td>
  </tr>
...
<?php endforeach; endif; unset($_from);  elseif ($this->_tpl_vars['type'] == 4):  $_from = $this->_tpl_vars['orders']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['orderitem'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['orderitem']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['order']):
        $this->_foreach['orderitem']['iteration']++;
?>
<div style="width:600px" <?php if (($this->_foreach['orderitem']['iteration'] == $this->_foreach['orderitem']['total'])):  else: ?>class="pagebreak"<?php endif; ?>>
<div style="width:50%;float:left;margin:0;padding:0">
<ul>
<li><b>TO:</b><?php echo $this->_tpl_vars['order']['consignee']; ?>
</li>
<li><?php echo $this->_tpl_vars['order']['street1']; ?>
  <?php echo $this->_tpl_vars['order']['street2']; ?>
</li>
<li><?php echo $this->_tpl_vars['order']['city']; ?>
,<?php echo $this->_tpl_vars['order']['state']; ?>
,<?php echo $this->_tpl_vars['order']['zipcode']; ?>
</li>
<li><?php echo $this->_tpl_vars['order']['country']; ?>
</li>
<li><?php echo $this->_tpl_vars['order']['tel']; ?>
</li>                
</ul>
</div>
<div style="width:50%;float:left;margin:0;padding:0">
<ul>
<li><span class="STYLE1">*<?php echo $this->_tpl_vars['order']['order_sn']; ?>
*</span></li>
<li>配货信息:</li>
<li><?php $_from = $this->_tpl_vars['order']['goodsarr']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach["goodsitem}"] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach["goodsitem}"]['total'] > 0):
    foreach ($_from as $this->_tpl_vars['goods']):
        $this->_foreach["goodsitem}"]['iteration']++;
 echo $this->_tpl_vars['goods']['goods_sn']; ?>
&&<?php echo $this->_tpl_vars['goods']['goods_qty']; ?>
<br>
<?php endforeach; endif; unset($_from); ?>
</li>
<?php if ($this->_tpl_vars['order']['pay_note']): ?><li>备注:<?php echo $this->_tpl_vars['order']['pay_note']; ?>
</li><?php endif; ?>
</ul>
</div>
</div>
<?php endforeach; endif; unset($_from);  elseif ($this->_tpl_vars['type'] == 5): ?><!-新加坡挂号-->
...
<span style="font-size:16px;"><b><?php echo $this->_tpl_vars['order']['country']; ?>
(<?php echo $this->_tpl_vars['order']['Cncountry']; ?>
)</b><br>
<b><?php echo $this->_tpl_vars['order']['tel']; ?>
</b><br>
...
<div style="text-align:right;clear:right;margin-top:-18px;"><span style="font-family:C39HrP24DhTt;font-size:30px;">*<?php echo $this->_tpl_vars['order']['order_sn']; ?>
*</span></div>
</li>
<li><span style="font-size:8px"><?php echo $this->_tpl_vars['order']['total']; ?>
---
<?php $_from = $this->_tpl_vars['order']['goodsarr']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach["goodsitem}"] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach["goodsitem}"]['total'] > 0):
    foreach ($_from as $this->_tpl_vars['goods']):
        $this->_foreach["goodsitem}"]['iteration']++;
 echo $this->_tpl_vars['goods']['goods_sn'];  if ($this->_tpl_vars['goods']['goods_qty'] > 1): ?>&<?php echo $this->_tpl_vars['goods']['goods_qty'];  endif; ?>,
<?php endforeach; endif; unset($_from); ?></span>
</li>
</ul>
</div>
<div <?php if (! ($this->_foreach['orderitem']['iteration'] == $this->_foreach['orderitem']['total']) && ! ($this->_foreach['orderitem']['iteration'] <= 1) && ( ($this->_foreach['orderitem']['iteration']-1)+1 ) % 8 == 0): ?>class="pagebreak"<?php endif; ?>></div>
<?php endforeach; endif; unset($_from); ?>
</div>
<?php elseif ($this->_tpl_vars['type'] == 6): ?><!-新加坡小包-->
<div style="width:800px;float:left;">
<?php $_from = $this->_tpl_vars['orders']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['orderitem'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['orderitem']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['order']):
...
<?php elseif ($this->_tpl_vars['type'] == 134): ?><!--A4-->
<?php $_from = $this->_tpl_vars['orders']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['orderitem'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['orderitem']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['order']):
        $this->_foreach['orderitem']['iteration']++;
 if (($this->_foreach['orderitem']['iteration']-1) % 5 == 0): ?>
    ...
    <table style="border: 1px dashed #999999;width: 190mm">
      <tr>
         <td width="115"  valign="top" style="border-right:#000000 1px dashed;">
            <span id="labelspan" style="text-align:center;"><img src="index.php?model=login&action=Barcode&number=<?php echo $this->_tpl_vars['order']['order_sn']; ?>
&height=35">
    <div style="font-size:13px;margin-top:-20px;letter-spacing:4px;width:206px"><center>*<?php echo $this->_tpl_vars['order']['order_sn']; ?>
*</center></div></span><br />
            <span style="font-size: 9px;font-family:Arial;float:right"><?php echo ((is_array($_tmp=time())) ? $this->_run_mod_handler('date_format', true, $_tmp, '%Y-%m-%d') : smarty_modifier_date_format($_tmp, '%Y-%m-%d')); ?>
</span><br />
            <span style="font-size: 12px;font-family:Arial;">ID:<?php echo $this->_tpl_vars['order']['userid']; ?>
&nbsp;</span><br />
            <span style="font-size: 12px;font-family:Arial;">订单号:<?php echo $this->_tpl_vars['order']['paypalid']; ?>
&nbsp;</span><br />

            <span style="font-size: 12px;font-family:Arial;">物流方式:<?php echo $this->_tpl_vars['order']['ShippingService']; ?>
</span><br />

            <span style="font-size: 12px;font-family:Arial;">重量:</span><span style="font-size: 12px;font-family:Arial;"><?php echo $this->_tpl_vars['order']['weight']; ?>
&nbsp;</span><br />

            <span style="font-size: 12px;font-family:Arial;">运费:&nbsp;<?php echo $this->_tpl_vars['order']['shipping_cost']; ?>
</span><br />
            ...
            <table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0" style="word-break: break-all;break-all;position:relative;">
               <tr>
                  <td valign="top">
                    ...
                    <span style="font-size:25px;font-weight:800;" ><?php echo $this->_tpl_vars['order']['total']; ?>
</span><br/>
                      <?php $_from = $this->_tpl_vars['order']['goodsarr']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach["goodsitem}"] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach["goodsitem}"]['total'] > 0):
    foreach ($_from as $this->_tpl_vars['goods']):
        $this->_foreach["goodsitem}"]['iteration']++;
?>
                     <font style="font-size:10px"><?php echo $this->_tpl_vars['goods']['goods_qty']; ?>
 * <?php echo $this->_tpl_vars['goods']['goods_sn']; ?>
 <?php echo $this->_tpl_vars['goods']['goods_attribute']; ?>
</font><img src="<?php echo $this->_tpl_vars['goods']['goods_img']; ?>
" width="75px"/>
                    <br/>
                    <?php endforeach; endif; unset($_from); ?>
                   <?php if ($this->_tpl_vars['order']['pay_note']): ?><br/><div style="font-size:10px">备注:<?php echo $this->_tpl_vars['order']['pay_note'];  endif; ?></div>
                  </td>
               </tr>
            </table>
         </td>
         <td width="420" valign="top">
            <table width="95%" border="0" cellspacing="0" cellpadding="0">
               <tr>
                  ...
                  <span id="labelspan" style="text-align:center;"><img src="index.php?model=login&action=Barcode&number=<?php echo $this->_tpl_vars['order']['order_sn']; ?>
&height=30">
    <div style="font-size:11px;margin-top:-25px;letter-spacing:4px;width:206px"><center>*<?php echo $this->_tpl_vars['order']['order_sn']; ?>
*</center></div></span>
                     <div style="font-size: 14px; font-weight: bold">
                        <span style="margin-right:2px" >Send To:  <?php echo $this->_tpl_vars['order']['consignee']; ?>
</span><br/>
                        <?php echo $this->_tpl_vars['order']['street1']; ?>
&nbsp; <?php echo $this->_tpl_vars['order']['street2']; ?>
<br/>
...
(<?php echo $this->_tpl_vars['order']['Cncountry']; ?>
   ...
   </div><?php if (($this->_foreach['orderitem']['iteration']-1) % 5 == 4): ?>
</div>
<?php endif;  endforeach; endif; unset($_from);  elseif ($this->_tpl_vars['type'] == 135): ?><!--A4-->
...
<div <?php if (! ($this->_foreach['orderitem']['iteration'] == $this->_foreach['orderitem']['total']) && ! ($this->_foreach['orderitem']['iteration'] <= 1) && ( ($this->_foreach['orderitem']['iteration']-1)+1 ) % 10 == 0): ?>class="pagebreak"<?php endif; ?>></div>

<?php endforeach; endif; unset($_from);  elseif ($this->_tpl_vars['type'] == 136): ?><!--A4-->
<?php $_from = $this->_tpl_vars['orders']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['orderitem'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['orderitem']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['order']):
        $this->_foreach['orderitem']['iteration']++;
            ...
            <table width="95%" border="0" cellspacing="0" cellpadding="0">
               <tr>
                  <td colspan="2">
                    ...
                    <span id="labelspan" style="text-align:center;"><img src="index.php?model=login&action=Barcode&number=<?php echo $this->_tpl_vars['order']['track_no']; ?>
&height=50">
    <div style="font-size:13px;margin-top:-20px;letter-spacing:4px;width:206px"><center>*<?php echo $this->_tpl_vars['order']['track_no']; ?>
*</center></div></span>
...
(<?php echo $this->_tpl_vars['order']['Cncountry']; ?>
   ...
   </div><div style="clear:both"></div><?php if (($this->_foreach['orderitem']['iteration']-1) % 5 == 4): ?>
</div>
<?php endif;  endforeach; endif; unset($_from);  elseif ($this->_tpl_vars['type'] == 7): ?><!-新加坡小包单页-->
<?php $_from = $this->_tpl_vars['orders']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['orderitem'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['orderitem']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['order']):
        $this->_foreach['orderitem']['iteration']++;
?>
<div style="width:350px;" <?php if (($this->_foreach['orderitem']['iteration'] == $this->_foreach['orderitem']['total'])):  else: ?>class="pagebreak"<?php endif; ?>>
<ul>
<li>
<div style="font-size:12px;width:250px;float:left;height:20px;text-align:center">
</div>
</li>
<li style="clear:left;font-size:24px;margin-top:4px"><b>TO:<?php echo $this->_tpl_vars['order']['consignee']; ?>
</b></li>
<li style="font-size:22px;"><b><?php echo $this->_tpl_vars['order']['street1']; ?>
  <?php echo $this->_tpl_vars['order']['street2']; ?>
</b></li>
<li style="font-size:22px;width:320px;"><b><?php echo $this->_tpl_vars['order']['city']; ?>
,<?php echo $this->_tpl_vars['order']['state']; ?>
,<?php echo $this->_tpl_vars['order']['zipcode']; ?>
</b></li>
...
<b><?php echo $this->_tpl_vars['order']['tel']; ?>
</b><br><span style="font-size:12px"><?php echo $this->_tpl_vars['order']['allaccount']; ?>
</span>
</li>
<li><img src="index.php?model=login&action=Barcode&number=<?php echo $this->_tpl_vars['order']['order_sn']; ?>
&height=50"></li>
<li style="width:206px;margin-top:-20px;letter-spacing:4px;"><center>*<?php echo $this->_tpl_vars['order']['order_sn']; ?>
*</center></li>
<li><span style="font-size:12px;"><?php echo $this->_tpl_vars['order']['total']; ?>
---
<?php $_from = $this->_tpl_vars['order']['goodsarr']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach["goodsitem}"] = array('total' => count($_from), 'iteration' => 0);
...
<?php endforeach; endif; unset($_from);  elseif ($this->_tpl_vars['type'] == 17): ?><!-瑞士小包单页-->
<?php $_from = $this->_tpl_vars['orders']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['orderitem'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['orderitem']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['order']):
        $this->_foreach['orderitem']['iteration']++;
...
<li style="clear:left;font-size:20px;margin-top:4px"><b>TO:<?php echo $this->_tpl_vars['order']['consignee']; ?>
</b></li>
<li style="font-size:18px;"><b><?php echo $this->_tpl_vars['order']['street1']; ?>
  <?php echo $this->_tpl_vars['order']['street2']; ?>
</b></li>
<li style="font-size:18px;width:320px;"><b><?php echo $this->_tpl_vars['order']['city']; ?>
,<?php echo $this->_tpl_vars['order']['state']; ?>
,<?php echo $this->_tpl_vars['order']['zipcode']; ?>
</b></li>
...
<b><?php echo $this->_tpl_vars['order']['tel']; ?>
</b><br><span style="font-size:10px"><?php echo $this->_tpl_vars['order']['allaccount']; ?>
</span>
</li>
<li><img src="index.php?model=login&action=Barcode&number=<?php echo $this->_tpl_vars['order']['order_sn']; ?>
&height=50"></li>
<li style="width:206px;margin-top:-20px;letter-spacing:4px;"><center>*<?php echo $this->_tpl_vars['order']['order_sn']; ?>
*</center></li>
<li><span style="font-size:10px;"><?php echo $this->_tpl_vars['order']['total']; ?>
---
<?php $_from = $this->_tpl_vars['order']['goodsarr']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach["goodsitem}"] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach["goodsitem}"]['total'] > 0):
    foreach ($_from as $this->_tpl_vars['goods']):
...
<?php endforeach; endif; unset($_from);  elseif ($this->_tpl_vars['type'] == 18): ?><!-瑞士挂号单页-->
<?php $_from = $this->_tpl_vars['orders']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['orderitem'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['orderitem']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['order']):
        $this->_foreach['orderitem']['iteration']++;
...
<li style="font-size:18px;width:330px;"><b><?php echo $this->_tpl_vars['order']['city']; ?>
,<?php echo $this->_tpl_vars['order']['state']; ?>
,<?php echo $this->_tpl_vars['order']['zipcode']; ?>
</b></li>
<li style="font-size:18px;">
...
<b><?php echo $this->_tpl_vars['order']['tel']; ?>
</b><br><span style="font-size:12px">挂号--<?php echo $this->_tpl_vars['order']['allaccount']; ?>
</span>
</li>
<li><img src="index.php?model=login&action=Barcode&number=<?php echo $this->_tpl_vars['order']['order_sn']; ?>
&height=50"></li>
...
if ($this->_foreach["goodsitem}"]['total'] > 0):
    foreach ($_from as $this->_tpl_vars['goods']):
        $this->_foreach["goodsitem}"]['iteration']++;
 echo $this->_tpl_vars['goods']['goods_sn'];  if ($this->_tpl_vars['goods']['goods_qty'] > 1): ?>&<?php echo $this->_tpl_vars['goods']['goods_qty'];  endif; ?>,
<?php endforeach; endif; unset($_from); ?></span><?php if ($this->_tpl_vars['order']['note']): ?><br><?php echo $this->_tpl_vars['order']['note'];  endif; ?>
</li>
</ul>
</div>
<?php endforeach; endif; unset($_from);  elseif ($this->_tpl_vars['type'] == 113): ?><!-配货单->
<?php $_from = $this->_tpl_vars['orders']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['orderitem'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['orderitem']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['order']):
        $this->_foreach['orderitem']['iteration']++;
?>
<div <?php if (! ($this->_foreach['orderitem']['iteration'] == $this->_foreach['orderitem']['total']) && ! ($this->_foreach['orderitem']['iteration'] <= 1) && ( ($this->_foreach['orderitem']['iteration']-1)+1 ) % 6 == 0): ?>class="pagebreak"<?php endif; ?>>
              ...
              <tr>
                <td width="50%" valign="top">
                    <ul style="margin-left:10px;margin-top:5px;">
                        ...
                        <li style="font-size:26px;font-weight:800"><?php echo $this->_tpl_vars['order']['consignee']; ?>
</li>
                        <li style="font-size:26px;font-weight:800"><?php echo $this->_tpl_vars['order']['street1'];  echo $this->_tpl_vars['order']['street2']; ?>
</li>
                        <li style="font-size:26px;font-weight:800"><?php echo $this->_tpl_vars['order']['city']; ?>
,<?php if ($this->_tpl_vars['order']['state']):  echo $this->_tpl_vars['order']['state']; ?>
,<?php endif; ?> <?php echo $this->_tpl_vars['order']['zipcode']; ?>
</li>
                        <li style="font-size:26px;font-weight:800"><?php echo $this->_tpl_vars['order']['country']; ?>
(<?php echo $this->_tpl_vars['order']['Cncountry']; ?>
)</li>            
                    </ul>
                </td>
                <td width="20%" valign="top">
                    ...
                    <li><img src="index.php?model=login&action=Barcode&number=<?php echo $this->_tpl_vars['order']['order_sn']; ?>
&height=60"></li>
                    <li style="font-size:20px;width:222px;margin-top:-20px;margin-left:-10px;"><center><b><?php echo $this->_tpl_vars['order']['order_sn']; ?>
</b></center></li></td>
                <td width="30%" valign="top" style=" border-left:3px solid #000">
                    <br/>
                     <ul style="margin-left:10px;margin-top:5px;">
                        <li style="font-size:24px;"><?php echo $this->_tpl_vars['order']['shipping']; ?>
</li>
                        <?php $_from = $this->_tpl_vars['order']['goodsarr']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['goodsitem'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['goodsitem']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['goods']):
        $this->_foreach['goodsitem']['iteration']++;
?>
                        <li style="font-size:24px;"><?php echo $this->_tpl_vars['goods']['goods_sn']; ?>
[<?php echo $this->_tpl_vars['goods']['location']; ?>
]&nbsp;X&nbsp;<?php echo $this->_tpl_vars['goods']['goods_qty']; ?>
/</li>
                        <?php endforeach; endif; unset($_from); ?>
                    </ul>
...
</div><?php if (! ($this->_foreach['orderitem']['iteration'] == $this->_foreach['orderitem']['total'])): ?><div style="height:38px;">&nbsp;</div><?php endif;  endforeach; endif; unset($_from);  elseif ($this->_tpl_vars['type'] == 117): ?><!-国际EMS->
<?php $_from = $this->_tpl_vars['orders']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['orderitem'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['orderitem']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['order']):
        $this->_foreach['orderitem']['iteration']++;
?>
<div style="width:1357px;height:897px; background:url(/themes/default/template/order/ems.jpg);position:relative;" <?php if (($this->_foreach['orderitem']['iteration'] == $this->_foreach['orderitem']['total'])):  else: ?>class="pagebreak"<?php endif; ?>> 
    <div style="position:absolute;height:36px; left: 818px;font-size:20px; top: 151px;"><?php echo $this->_tpl_vars['order']['consignee']; ?>
</div>
    <div style="position:absolute;height:36px; left: 818px;font-size:20px; top: 211px;"><?php echo $this->_tpl_vars['order']['city']; ?>
</div>
    <div style="position:absolute;height:36px; left: 1020px;font-size:20px; top: 211px;"><?php echo $this->_tpl_vars['order']['country']; ?>
</div>
    <div style="position:absolute;height:36px; left: 818px;font-size:20px; top: 275px;"></div>
    <div style="position:absolute;height:90px; width:490px; left: 818px;font-size:20px; top: 330px; line-height:200%"><?php echo $this->_tpl_vars['order']['street1']; ?>
&nbsp;<?php echo $this->_tpl_vars['order']['street2']; ?>
,<?php echo $this->_tpl_vars['order']['city']; ?>
,<?php echo $this->_tpl_vars['order']['state']; ?>
</div>
    <div style="position:absolute;height:36px; width:373px; left: 818px;font-size:20px; top: 445px;"><?php echo $this->_tpl_vars['order']['zipcode']; ?>
</div>
    <div style="position:absolute;height:36px; width:373px; left: 1025px;font-size:20px; top: 445px;"><?php echo $this->_tpl_vars['order']['tel']; ?>
</div>
</div>   
<?php endforeach; endif; unset($_from);  elseif ($this->_tpl_vars['type'] == 170): ?><!-DHL-->
<div style="width:240mm;float:left;">
<?php $_from = $this->_tpl_vars['orders']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['orderitem'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['orderitem']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['order']):
...
<?php echo ((is_array($_tmp=$this->_tpl_vars['goods']['Declared_value'])) ? $this->_run_mod_handler('string_format', true, $_tmp, "%.2f") : smarty_modifier_string_format($_tmp, "%.2f")); ?>
                            ...
                            <td align="center" valign="top">
                                <span class="STYLE1">*<?php echo $this->_tpl_vars['order']['order_sn']; ?>
*</span>
                            </td>
                        </tr>
                    </table>
...
<?php elseif ($this->_tpl_vars['type'] == 13): ?><!-地址拣货10*10-->
<?php $_from = $this->_tpl_vars['orders']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['orderitem'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['orderitem']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['order']):
        $this->_foreach['orderitem']['iteration']++;
?>
<div style="font-family:Arial;width:75mm; height:95mm;" <?php if (($this->_foreach['orderitem']['iteration'] == $this->_foreach['orderitem']['total'])):  else: ?>class="pagebreak"<?php endif; ?>>
...
(<?php echo $this->_tpl_vars['order']['Cncountry']; ?>
      ...
      <li><img src="index.php?model=login&action=Barcode&number=<?php echo $this->_tpl_vars['order']['track_no']; ?>
&height=35"></li>
      <li><center style="margin-left:-20px;font-size:10px;margin-top:-25px;">*<?php echo $this->_tpl_vars['order']['track_no']; ?>
*</center></li>
            </ul>
            </td>
            <td style="font-size:10px"><?php echo $this->_tpl_vars['order']['shipping']; ?>
&nbsp;
            </td>
            </tr>
        </table>
  ...
  <tr>
    <td style="height:50mm"  valign="top"><table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
            <tr  style="height:25px; font-size:11px"><td style="height:25px; width:50%" align="left">sellerId:<?php echo $this->_tpl_vars['order']['sellerID']; ?>

        </td><td align="right"  style="height:25px; width:50%"><?php echo ((is_array($_tmp=time())) ? $this->_run_mod_handler('date_format', true, $_tmp, '%Y-%m-%d') : smarty_modifier_date_format($_tmp, '%Y-%m-%d')); ?>
&nbsp;&nbsp;</td></tr>
        ...
        <tr><td colspan="5" align="right" style="border-bottom:#000 1px solid;border-right:#000 1px solid;">
            总金额：<?php echo $this->_tpl_vars['order']['totalprice']; ?>
&nbsp;
            </td></tr>
        <?php $_from = $this->_tpl_vars['order']['goodsarr']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach["goodsitem}"] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach["goodsitem}"]['total'] > 0):
...
?>
            ...
            <b><?php echo $this->_tpl_vars['goods']['location']; ?>
</b>&nbsp;
            </td><td width="10%" align="center" style="border-bottom:#000 1px solid;border-right:#000 1px solid;"><b><?php echo $this->_tpl_vars['goods']['goods_qty']; ?>
</b>
...
<?php echo $this->_tpl_vars['goods']['goods_price']; ?>
&nbsp;
            </td></tr>
            <tr><td colspan="5" align="left" style="border-bottom:#000 1px solid;border-right:#000 1px solid;"><?php echo $this->_tpl_vars['goods']['goods_name']; ?>
        ...
        <table align="left">
            ...
            <?php if ($this->_tpl_vars['order']['pay_note']): ?><td style="font-size:14px;">备注:<?php echo $this->_tpl_vars['order']['pay_note']; ?>
</td><?php endif; ?>
            </tr>
        </table>
        </center>
            ...
            </td><td align="right">第<?php echo ($this->_foreach['orderitem']['iteration']-1)+1; ?>
页&nbsp;
            </td></tr>
        </table></td>
  </tr>
...
<?php endforeach; endif; unset($_from);  elseif ($this->_tpl_vars['type'] == 99):  $_from = $this->_tpl_vars['orders']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['orderitem'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['orderitem']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['order']):
        $this->_foreach['orderitem']['iteration']++;
?>
...
<div style="float:left;width:118px;padding:8px 15px;text-align:center"><p style="border:2px solid #000;text-align:left;padding:2px 0 2px 4px;">Airmail<br />Postage Paid<br />China Post</p><p style="font-size:40px;font-weight:bold;margin-top:-15px;"><?php echo $this->_tpl_vars['order']['area']; ?>
</p></div>
</div> <!-- 头部end-->
...
<img src="index.php?model=login&action=Barcode&number=420<?php echo ((is_array($_tmp=$this->_tpl_vars['order']['zipcode'])) ? $this->_run_mod_handler('truncate', true, $_tmp, 5, "", true) : smarty_modifier_truncate($_tmp, 5, "", true)); ?>
&height=65" style="margin-top:5px"/><br>
ZIP <?php echo $this->_tpl_vars['order']['zipcode']; ?>
...
<img src="index.php?model=login&action=Barcode&number=<?php echo $this->_tpl_vars['order']['track_no']; ?>
&height=90"><br>
<?php echo $this->_tpl_vars['order']['track_no']; ?>
...
<div style="float:left;border:1px solid #000;font-size:40px;width:50px;margin-left:5px;"><span style="margin:3px 0 0 15px"><?php echo $this->_tpl_vars['order']['area']; ?>
</span></div>
</div>
<div style="text-align:center;float:left;padding:35px 0 0 10px;">
<img src="index.php?model=login&action=Barcode&number=<?php echo $this->_tpl_vars['order']['track_no']; ?>
&height=53" style="margin-bottom:5px;">
<span style="font-weight:bold;"><?php echo $this->_tpl_vars['order']['track_no']; ?>
</span>
</div>
</div><!-- 头部end-->
...
SHIP TO:<?php echo $this->_tpl_vars['order']['consignee']; ?>
<br />
<?php echo $this->_tpl_vars['order']['street1']; ?>
  <?php echo $this->_tpl_vars['order']['street2']; ?>
<br />
...
<div style="font-size:16px;">PHONE: <?php echo $this->_tpl_vars['order']['tel']; ?>
</div>
</div>
</div><!-- 中部end-->
...
<div style="width:20px;border-right:1px solid #000;float:left;height:18px;text-align:right;"></div><div style="width:30px;border-right:1px solid #000;float:left;height:18px;"><?php echo $this->_tpl_vars['order']['total']; ?>
</div><div style="width:230px;border-right:1px solid #000;float:left;height:18px;">Total Gross Weight (Kg.):</div><div style="height:18px;width:50px;border-right:1px solid #000;float:left;"><?php echo $this->_tpl_vars['order']['total']*0.050; ?>
</div><div style="width:50px;border-right:1px solid #000;float:left;height:18px;"><?php echo $this->_tpl_vars['order']['total']*2; ?>
</div><div style="float:left;"></div>
</div>
<div style="font-size:14px;margin-top:-150px; width:450px;height:130px;">
<div style="width:20px;border-right:1px solid #000;float:left;text-align:right;">1</div><div style="width:30px;border-right:1px solid #000;float:left;"><?php echo $this->_tpl_vars['order']['total']; ?>
</div><div style="width:230px;border-right:1px solid #000;font-size:12px;float:left;height:130px;word-wrap: break-word; word-break: normal;">fashion jewelry <?php echo $this->_tpl_vars['order']['good_eubstr']; ?>
 流行饰品</div><div style="width:50px;border-right:1px solid #000;float:left;"><?php echo $this->_tpl_vars['order']['total']*0.050; ?>
</div><div style="width:50px;border-right:1px solid #000;float:left;"><?php echo $this->_tpl_vars['order']['total']*2; ?>
</div><div style="float:left;">China</div>
</div>
</div><!--产品表end-->
...
<?php endforeach; endif; unset($_from);  elseif ($this->_tpl_vars['type'] == 77): ?><!-合并打印-->
<center>傲基电子商务有限公司(<?php echo ((is_array($_tmp=time())) ? $this->_run_mod_handler('date_format', true, $_tmp, "%Y-%m-%d %H:%M:%S") : smarty_modifier_date_format($_tmp, "%Y-%m-%d %H:%M:%S")); ?>
)</center>
...
if ($this->_foreach['orderitem']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['order']):
        $this->_foreach['orderitem']['iteration']++;
?>
<tr><td class="bbb"><?php echo ($this->_foreach['orderitem']['iteration']-1)+1; ?>
</td><td class="bbb"><span class="STYLE1">*<?php echo $this->_tpl_vars['order']['order_sn']; ?>
*</span></td>
<td class="bbb">
<table width="100%">
<?php $_from = $this->_tpl_vars['order']['goodsarr']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach["goodsitem}"] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach["goodsitem}"]['total'] > 0):
    foreach ($_from as $this->_tpl_vars['goods']):
        $this->_foreach["goodsitem}"]['iteration']++;
?>
<tr><td width="50%"><?php echo $this->_tpl_vars['goods']['goods_sn']; ?>
</td><td width="20%"><?php echo $this->_tpl_vars['goods']['goods_qty']; ?>
</td><td width="30%"><?php echo $this->_tpl_vars['goods']['location']; ?>
</td></tr>
<?php endforeach; endif; unset($_from); ?>
</table>
</td>
<td class="bbb"><?php echo $this->_tpl_vars['order']['country']; ?>
</td>
<td class="bbb"><?php echo $this->_tpl_vars['order']['pay_note']; ?>
&nbsp;<?php echo $this->_tpl_vars['order']['note']; ?>
</td>
</tr>
<?php endforeach; endif; unset($_from); ?>
</table>

<?php elseif ($this->_tpl_vars['type'] == 161): ?><!--中国邮政航空小包挂号(广东)A4-->
<?php $_from = $this->_tpl_vars['orders']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['orderitem'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['orderitem']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['order']):
        $this->_foreach['orderitem']['iteration']++;
...
<br>
            ...
            <tr>
                <td valign="top" colspan="2"
                    ...
                    <div
                    style="font-size: 12px; float: left; word-spacing: normal; width: 201px;">
                <u>TO:&nbsp;</u> <b style="font-size: 12px"><?php echo $this->_tpl_vars['order']['consignee']; ?>
</b> 
                <br>
                <font style="font-size:12px">
           <?php echo $this->_tpl_vars['order']['street1']; ?>
          ...
          <table cellpadding="1" cellspacing="1"
                    ...
                    <tr>
                        ...
                        <table cellpadding="0" cellspacing="0">
                            <tr>
                                <td valign="top" align="center" style="font-size: 13px"><b>
                             RC<?php echo $this->_tpl_vars['order']['track_no']; ?>
CN
                         </b></td>
                            </tr>
                            <tr>
...
&height=35">
                    ...
                    <tr>
                        ...
                        中国邮政航空小包挂号(广东)&nbsp;<?php echo $this->_tpl_vars['order']['order_sn']; ?>
&nbsp;RefNo:<?php echo $this->_tpl_vars['order']['paypalid']; ?>
...
<div style="width:162mm;">
    <div style="float:left; width:44%; text-align:center; margin-top:10px;">
        <div><img src="index.php?model=login&action=Barcode&number=<?php echo $this->_tpl_vars['order']['paypalid']; ?>
&height=35"></div>
        <div><?php echo $this->_tpl_vars['order']['paypalid']; ?>
</div>
    </div>
...
?>
            <tr>
                ...
                <td><?php echo $this->_tpl_vars['order']['ShippingService']; ?>
</td>
                <td><?php if ($this->_tpl_vars['order']['pay_note']):  echo $this->_tpl_vars['order']['pay_note'];  endif; ?></td>
            </tr>
            <?php endforeach; endif; unset($_from); ?>
        </table>
    </div>
...
<?php elseif ($this->_tpl_vars['type'] == 162): ?><!--香港小包挂号A4-->
<?php $_from = $this->_tpl_vars['orders']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['orderitem'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['orderitem']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['order']):
        $this->_foreach['orderitem']['iteration']++;
...
&height=35">
                    ...
                    <tr>
                        ...
                        香港小包挂号&nbsp;<?php echo $this->_tpl_vars['order']['order_sn']; ?>
&nbsp;RefNo:<?php echo $this->_tpl_vars['order']['paypalid']; ?>
...
<?php elseif ($this->_tpl_vars['type'] == 163): ?><!--瑞典小包挂号A4-->
<?php $_from = $this->_tpl_vars['orders']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['orderitem'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['orderitem']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['order']):
        $this->_foreach['orderitem']['iteration']++;
...
&height=35">
                              ...
                              <tr>
                                <td valign="top" align="center" style="font-size: 13px"><b>
                             RE<?php echo $this->_tpl_vars['order']['track_no']; ?>
SE
                         </b></td>
                            </tr>
                        </table>
                    ...
                    <tr>
                        <td style="border: solid #000 1px; font-size: 8px" colspan="2" align="center">
                        瑞典小包挂号&nbsp;<?php echo $this->_tpl_vars['order']['order_sn']; ?>
&nbsp;RefNo:<?php echo $this->_tpl_vars['order']['paypalid']; ?>
...
<DIV id=C8>
    ...
    <div style="float:right; width:50%; text-align:right; margin-right:-30px;">
        <span style="font-weight:bold; font-size:11px;"><BR />ref no:<br /><?php echo $this->_tpl_vars['order']['paypalid']; ?>
</span><br /><span style="font-size:9px;"><?php echo ((is_array($_tmp=time())) ? $this->_run_mod_handler('date_format', true, $_tmp, '%A,%b,%d,%Y') : smarty_modifier_date_format($_tmp, '%A,%b,%d,%Y')); ?>
</span>
    </div>
</DIV>
</DIV>
...
<?php elseif ($this->_tpl_vars['type'] == 164): ?><!--瑞典挂号(三区)A4-->
<?php $_from = $this->_tpl_vars['orders']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['orderitem'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['orderitem']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['order']):
        $this->_foreach['orderitem']['iteration']++;
...
&height=35">
                              ...
                              <tr>
                                <td valign="top" align="center" style="font-size: 13px"><b>
                             RS<?php echo $this->_tpl_vars['order']['track_no']; ?>
CH
                         </b></td>
                            </tr>
                        </table>
                    ...
                    <tr>
                        <td style="border: solid #000 1px; font-size: 8px" colspan="2" align="center">
                        瑞士挂号(三区)&nbsp;<?php echo $this->_tpl_vars['order']['order_sn']; ?>
&nbsp;RefNo:<?php echo $this->_tpl_vars['order']['paypalid']; ?>
...
<?php elseif ($this->_tpl_vars['type'] == 165): ?><!--新加坡小包挂号(五区)A4-->
<?php $_from = $this->_tpl_vars['orders']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['orderitem'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['orderitem']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['order']):
        $this->_foreach['orderitem']['iteration']++;
          ...
          <table cellpadding="2" cellspacing="0"
                    ...
                    <tr>
                        ...
                        <table cellpadding="0" cellspacing="0">
                            <tr>
                                <td valign="top" align="center" style="font-size: 13px"><b>
                             RQ<?php echo $this->_tpl_vars['order']['track_no']; ?>
SG
                         </b></td>
                            </tr>
                            <tr>
...
<?php elseif ($this->_tpl_vars['type'] == 166): ?><!--检货单(new)A4-->
<?php $_from = $this->_tpl_vars['orders']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['orderitem'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['orderitem']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['order']):
        $this->_foreach['orderitem']['iteration']++;
...
<?php elseif ($this->_tpl_vars['type'] == 167): ?><!--ebay invoice-->
<?php $_from = $this->_tpl_vars['orders']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['orderitem'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['orderitem']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['order']):
        $this->_foreach['orderitem']['iteration']++;
  ...
  <tr>
    <td >
      <table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0" style="word-break:break-all; font-family: Arial, Helvetica, sans-serif;">
        <tr>
          <td width="27%" height="20" style="font-size:12px; font-family:Arial, Helvetica, sans-serif;font-weight:bold">Order Number: <?php echo $this->_tpl_vars['order']['order_sn']; ?>
</td>
        ...
        <tr>
          ...
          <td colspan="3" style="font-size:12px; font-family:Arial, Helvetica, sans-serif;font-weight:bold"><?php echo $this->_tpl_vars['order']['consignee']; ?>
</td>
          </tr>
        <tr>
          <td style="font-size:12px; font-family:Arial, Helvetica, sans-serif;font-weight:bold">Company Name:</td>
          <td colspan="3" style="font-size:12px; font-family:Arial, Helvetica, sans-serif;font-weight:bold"> <?php echo $this->_tpl_vars['params']['Company']; ?>
</td>
          </tr>
        <tr>
          <td style="font-size:12px; font-family:Arial, Helvetica, sans-serif;font-weight:bold">Address Line 1 :</td>
          <td colspan="3" style="font-size:12px; font-family:Arial, Helvetica, sans-serif;font-weight:bold"> <?php echo $this->_tpl_vars['order']['street1']; ?>
</td>
          </tr>
        <tr>
          <td style="font-size:12px; font-family:Arial, Helvetica, sans-serif;font-weight:bold">Address Line 2 :</td>
          <td colspan="3" style="font-size:12px; font-family:Arial, Helvetica, sans-serif;font-weight:bold"><?php echo $this->_tpl_vars['order']['street2']; ?>
</td>
          </tr>
        <tr>
          <td style="font-size:12px; font-family:Arial, Helvetica, sans-serif;font-weight:bold">City :</td>
          <td colspan="3" style="font-size:12px; font-family:Arial, Helvetica, sans-serif;font-weight:bold"><?php echo $this->_tpl_vars['order']['city']; ?>
</td>
          </tr>
        <tr>
          <td style="font-size:12px; font-family:Arial, Helvetica, sans-serif;font-weight:bold">State :</td>
          <td width="25%" style="font-size:12px; font-family:Arial, Helvetica, sans-serif;font-weight:bold"><?php echo $this->_tpl_vars['order']['state']; ?>
</td>
          <td width="27%" style="font-size:12px; font-family:Arial, Helvetica, sans-serif;font-weight:bold">Postcode: </td>
          <td width="21%" style="font-size:12px; font-family:Arial, Helvetica, sans-serif;font-weight:bold"><?php echo $this->_tpl_vars['order']['zipcode']; ?>
</td>
          </tr>
        <tr>
          <td style="font-size:12px; font-family:Arial, Helvetica, sans-serif;font-weight:bold">Phone :</td>
          <td colspan="3" style="font-size:12px; font-family:Arial, Helvetica, sans-serif;font-weight:bold"><?php echo $this->_tpl_vars['order']['tel']; ?>
</td>
          </tr>
        <tr>
        ...
        <tr>
          ...
          <td colspan="3" style="font-size:12px; font-family:Arial, Helvetica, sans-serif;font-weight:bold"><?php echo $this->_tpl_vars['order']['ShippingService']; ?>
</td>
          </tr>
        </table>
    </td>
...
?>
          <tr>
            <td style="font-size:14px; font-family:Arial, Helvetica, sans-serif" align="center"><?php echo $this->_tpl_vars['goods']['goods_sn']; ?>
</td>
            <td style="font-size:14px; font-family:Arial, Helvetica, sans-serif;" align="center"><?php echo $this->_tpl_vars['goods']['goods_qty']; ?>
</td>
            <td style="font-size:14px; font-family:Arial, Helvetica, sans-serif;" align="center"><?php echo $this->_tpl_vars['goods']['goods_name']; ?>
</td>
            <td style="font-size:14px; font-family:Arial, Helvetica, sans-serif;" align="center"><?php echo ((is_array($_tmp=$this->_tpl_vars['goods']['goods_price'])) ? $this->_run_mod_handler('string_format', true, $_tmp, "%.2f") : smarty_modifier_string_format($_tmp, "%.2f")); ?>
</td>
            <td ><div align="center"><?php echo ((is_array($_tmp=$this->_tpl_vars['goods']['goods_price']*$this->_tpl_vars['goods']['goods_qty'])) ? $this->_run_mod_handler('string_format', true, $_tmp, "%.2f") : smarty_modifier_string_format($_tmp, "%.2f")); ?>
</div></td>
          </tr>
          <?php endforeach; endif; unset($_from); ?>
            ...
            <td width="43%">
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  ...
                  <br />
                  ORDER STATUS: <?php echo '<?php'; ?>
 echo $row_Recordset2['status']; if($row_Recordset2['status'] == "transfer"){ echo " Due date: ".$row_Recordset2['transfer_due'];}<?php echo '?>'; ?>
</div></td>
                </tr>
              </table>
            </td>
...
<?php elseif ($this->_tpl_vars['type'] == 168): ?><!--iiBuy invoice-->
<?php $_from = $this->_tpl_vars['orders']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['orderitem'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['orderitem']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['order']):
        $this->_foreach['orderitem']['iteration']++;
...
?>
      <tr>
        <td style="font-size:14px; font-family:Arial, Helvetica, sans-serif" align="center"><table cellpadding="2" cellspacing="0" border="0" width="100%">
          <tbody>
            <tr>
              <td align="center"><?php echo $this->_tpl_vars['goods']['goods_sn']; ?>
</td>
              </tr>
          </tbody>
        </table></td>
        ...
        <td style="font-size:14px; font-family:Arial, Helvetica, sans-serif;" align="center"><table cellpadding="2" cellspacing="0" border="0" width="100%">
          <tbody>
            <tr>
              <td align="center"><?php echo ((is_array($_tmp=$this->_tpl_vars['goods']['goods_price'])) ? $this->_run_mod_handler('string_format', true, $_tmp, "%.2f") : smarty_modifier_string_format($_tmp, "%.2f")); ?>
</td>
              </tr>
          </tbody>
        </table></td>
...
<?php elseif ($this->_tpl_vars['type'] == 333): ?> 
<style type="text/css">
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0" style=" margin-left:5px">
      <tr>
        ...
        <td width="26%"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td align="center"><font style="font-family:Arial; font-size:16px"><?php echo $this->_tpl_vars['order']['isd']; ?>
</font>&nbsp;</td>
          </tr>
        </table></td>
      </tr>
          ...
          <tr>
            <td align="center"><table width="100%" border="0" cellspacing="1" cellpadding="0">
              <tr>
                ...
                <img src="common/lib/barcodegen/html/image.php?filetype=PNG&dpi=372&scale=2&rotation=0&font_family=Arial.ttf&font_size=0&text=<?php echo $this->_tpl_vars['order']['zipcode']; ?>
&thickness=30&start=NULL&code=BCGcode128">
                
                </div></td>
              </tr>
              <tr>
                <td align="center"><div style="font-size:12px"><strong>ZIP <?php echo $this->_tpl_vars['order']['zipcode']; ?>
</strong></div></td>
              </tr>
            </table></td>
          </tr>
        ...
        <td height="109" style="border-right:#000 1px solid; font-size: 9px;"><table width="100%" border="0" cellspacing="2" cellpadding="0">
          ...
          <tr>
            <td align="center" ><div > 
                ...
                <img src="common/lib/barcodegen/html/image.php?filetype=PNG&dpi=372&scale=2&rotation=0&font_family=Arial.ttf&font_size=0&text=<?php echo $this->_tpl_vars['order']['track_no']; ?>
&thickness=35&start=NULL&code=BCGcode128"> 
            
            
            </div></td>
          </tr>
          <tr>
            <td align="center"><div style="font-size:12px"><strong><?php echo $this->_tpl_vars['order']['track_no']; ?>
</strong></div></td>
          </tr>
        </table></td>
      </tr>
      ...
      <table width="100%" border="0" cellspacing="1" cellpadding="3">
        <tr>
          <td width="38%"><table width="92%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              ...
              <td><table width="70%" height="32" border="0" cellpadding="0" cellspacing="0" style="border:1px solid #000; text-align:center; margin-right:">
                <tr>
                  <td width="100" height="20" ><font style="font-family:Arial; font-size:24px"><?php echo $this->_tpl_vars['order']['isd']; ?>
</font>&nbsp;</td>
                </tr>
              </table></td>
            </tr>
          ...
          <td width="62%"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td align="center"><div style="">  <img src="common/lib/barcodegen/html/image.php?filetype=PNG&dpi=72&scale=1&rotation=0&font_family=Arial.ttf&font_size=10&text=<?php echo $this->_tpl_vars['order']['track_no']; ?>
&thickness=40&start=NULL&code=BCGcode128"/> </div></td>
            </tr>
            <tr>
              <td align="center"><div style="font-size:12px"><strong><?php echo $this->_tpl_vars['order']['track_no']; ?>
</strong></div></td>
  ...
  <tr>
    ...
    <td height="143" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      Dongguan&nbsp; <br />Dongguan GUANGDONG <br />
        ...
        <td width="48%" rowspan="2" valign="top" style="border-top:#000 solid 1px"><div style=" font-size:13px; font-family:Arial, Helvetica, sans-serif">SHIP TO: <?php echo $this->_tpl_vars['order']['consignee']; ?>
<br />
        <?php echo $this->_tpl_vars['order']['street1']; ?>
,<?php echo $this->_tpl_vars['order']['street2']; ?>
  <?php echo $this->_tpl_vars['order']['city']; ?>
, <?php echo $this->_tpl_vars['order']['state'];  echo $this->_tpl_vars['order']['country']; ?>
&nbsp; <?php echo $this->_tpl_vars['order']['zipcode']; ?>
<br></div></td>
      </tr>
      <tr >
      ...
      <tr >
        ...
        <td style="border-bottom: 1px solid #000"><div style=" font-size:12px">PHONE: <?php echo $this->_tpl_vars['order']['tel']; ?>
</div></td>
      </tr>
      <tr >
...
if ($this->_foreach['goodsitem']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['goods']):
        $this->_foreach['goodsitem']['iteration']++;
?>
              <?php $this->assign('xx', ($this->_foreach['goodsitem']['iteration']-1)+1); ?>    
           <?php endforeach; endif; unset($_from); ?>
           
          <tr>
             <td align="center"  style=" border-right:#000 1px solid;border-bottom: 0px solid #000;"> <?php if ($this->_tpl_vars['order']['goodsarr'][0]['goods_qty']): ?>  1 <?php else: ?> &nbsp; <?php endif; ?>   </td>
             <td align="center"  style=" border-right:#000 1px solid;border-bottom: 0px solid #000;"> <?php if ($this->_tpl_vars['order']['goodsarr'][0]['goods_qty']): ?> <?php echo $this->_tpl_vars['order']['goodsarr'][0]['goods_qty']; ?>
 <?php else: ?> &nbsp; <?php endif; ?>  </td>
             <td height="100%" align="center"  style=" border-right:#000 1px solid;border-bottom: 0px solid #000;font-size:12px;"> <?php if ($this->_tpl_vars['order']['goodsarr'][0]['goods_qty']): ?> Accessories 配件 <?php echo $this->_tpl_vars['order']['goodsarr'][0]['goods_sn']; ?>
 <?php echo $this->_tpl_vars['order']['goodsarr'][0]['location']; ?>
 <?php else: ?> &nbsp; <?php endif; ?> </td>
             <td align="center"  style=" border-right:#000 1px solid;border-bottom: 0px solid #000;"> <?php if ($this->_tpl_vars['order']['goodsarr'][0]['goods_qty']): ?>   0.01 <?php else: ?> &nbsp; <?php endif; ?>  </td>
             <td align="center"  style=" border-right:#000 1px solid;border-bottom: 0px solid #000;"> <?php if ($this->_tpl_vars['order']['goodsarr'][0]['goods_qty']): ?>   1<?php else: ?> &nbsp; <?php endif; ?>  </td>
              <td align="center"  style=" "> <?php if ($this->_tpl_vars['order']['goodsarr'][0]['goods_qty']): ?>  China <?php else: ?> &nbsp; <?php endif; ?> </td>
          </tr>
           <tr>
             <td align="center"  style=" border-right:#000 1px solid;border-bottom: 0px solid #000;"> <?php if ($this->_tpl_vars['order']['goodsarr'][1]['goods_qty']): ?>  2 <?php else: ?> &nbsp; <?php endif; ?>   </td>
             <td align="center"  style=" border-right:#000 1px solid;border-bottom: 0px solid #000;"> <?php if ($this->_tpl_vars['order']['goodsarr'][1]['goods_qty']): ?> <?php echo $this->_tpl_vars['order']['goodsarr'][1]['goods_qty']; ?>
 <?php else: ?> &nbsp; <?php endif; ?> </td>
             <td height="100%" align="center"  style=" border-right:#000 1px solid;border-bottom: 0px solid #000;font-size:12px;"> <?php if ($this->_tpl_vars['order']['goodsarr'][1]['goods_qty']): ?> Accessories 配件 <?php echo $this->_tpl_vars['order']['goodsarr'][1]['goods_sn']; ?>
 <?php echo $this->_tpl_vars['order']['goodsarr'][1]['location'];  else: ?> &nbsp; <?php endif; ?> </td>
             <td align="center"  style=" border-right:#000 1px solid;border-bottom: 0px solid #000;"> <?php if ($this->_tpl_vars['order']['goodsarr'][1]['goods_qty']): ?>   0.01 <?php else: ?> &nbsp; <?php endif; ?>  </td>
             <td align="center"  style=" border-right:#000 1px solid;border-bottom: 0px solid #000;"> <?php if ($this->_tpl_vars['order']['goodsarr'][1]['goods_qty']): ?>   1<?php else: ?> &nbsp; <?php endif; ?>  </td>
              <td align="center"  style=" "> <?php if ($this->_tpl_vars['order']['goodsarr'][1]['goods_qty']): ?>  China <?php else: ?> &nbsp; <?php endif; ?>  </td>
          </tr>
          <tr>
             <td align="center"  style=" border-right:#000 1px solid;border-bottom: 0px solid #000;"> <?php if ($this->_tpl_vars['order']['goodsarr'][2]['goods_qty']): ?>  3 <?php else: ?> &nbsp; <?php endif; ?>   </td>
             <td align="center"  style=" border-right:#000 1px solid;border-bottom: 0px solid #000;"> <?php if ($this->_tpl_vars['order']['goodsarr'][2]['goods_qty']): ?> <?php echo $this->_tpl_vars['order']['goodsarr'][2]['goods_qty']; ?>
 <?php else: ?> &nbsp; <?php endif; ?> </td>
             <td height="100%" align="center"  style=" border-right:#000 1px solid;border-bottom: 0px solid #000;font-size:12px;">  <?php if ($this->_tpl_vars['order']['goodsarr'][2]['goods_qty']): ?> Accessories 配件 <?php echo $this->_tpl_vars['order']['goodsarr'][2]['goods_sn']; ?>
 <?php echo $this->_tpl_vars['order']['goodsarr'][2]['location'];  else: ?> &nbsp; <?php endif; ?> </td>
             <td align="center"  style=" border-right:#000 1px solid;border-bottom: 0px solid #000;"> <?php if ($this->_tpl_vars['order']['goodsarr'][2]['goods_qty']): ?>   0.01 <?php else: ?> &nbsp; <?php endif; ?>  </td>
             <td align="center"  style=" border-right:#000 1px solid;border-bottom: 0px solid #000;"> <?php if ($this->_tpl_vars['order']['goodsarr'][2]['goods_qty']): ?>   1<?php else: ?> &nbsp; <?php endif; ?>  </td>
              <td align="center"  style=" "> <?php if ($this->_tpl_vars['order']['goodsarr'][2]['goods_qty']): ?>  China <?php else: ?> &nbsp; <?php endif; ?>  </td>
          </tr>
          <tr>
             <td align="center"  style=" border-right:#000 1px solid;border-bottom: 0px solid #000;"> <?php if ($this->_tpl_vars['order']['goodsarr'][3]['goods_qty']): ?>  4 <?php else: ?> &nbsp; <?php endif; ?>   </td>
             <td align="center"  style=" border-right:#000 1px solid;border-bottom: 0px solid #000;"> <?php if ($this->_tpl_vars['order']['goodsarr'][3]['goods_qty']): ?> <?php echo $this->_tpl_vars['order']['goodsarr'][3]['goods_qty']; ?>
 <?php else: ?> &nbsp; <?php endif; ?>  </td>
             <td height="100%" align="center"  style=" border-right:#000 1px solid;border-bottom: 0px solid #000;font-size:12px;">  <?php if ($this->_tpl_vars['order']['goodsarr'][3]['goods_qty']): ?> Accessories 配件 <?php echo $this->_tpl_vars['order']['goodsarr'][3]['goods_sn']; ?>
 <?php echo $this->_tpl_vars['order']['goodsarr'][3]['location'];  else: ?> &nbsp; <?php endif; ?> </td>
             <td align="center"  style=" border-right:#000 1px solid;border-bottom: 0px solid #000;"> <?php if ($this->_tpl_vars['order']['goodsarr'][3]['goods_qty']): ?>   0.01 <?php else: ?> &nbsp; <?php endif; ?>  </td>
             <td align="center"  style=" border-right:#000 1px solid;border-bottom: 0px solid #000;"> <?php if ($this->_tpl_vars['order']['goodsarr'][3]['goods_qty']): ?>   1<?php else: ?> &nbsp; <?php endif; ?>  </td>
              <td align="center"  style=" "> <?php if ($this->_tpl_vars['order']['goodsarr'][3]['goods_qty']): ?>  China <?php else: ?> &nbsp; <?php endif; ?>  </td>
          </tr>
          <tr>
             <td align="center"  style=" border-right:#000 1px solid;border-bottom: 0px solid #000;"> <?php if ($this->_tpl_vars['order']['goodsarr'][4]['goods_qty']): ?>  5 <?php else: ?> &nbsp; <?php endif; ?>   </td>
             <td align="center"  style=" border-right:#000 1px solid;border-bottom: 0px solid #000;"> <?php if ($this->_tpl_vars['order']['goodsarr'][4]['goods_qty']): ?> <?php echo $this->_tpl_vars['order']['goodsarr'][4]['goods_qty']; ?>
 <?php else: ?> &nbsp; <?php endif; ?> </td>
             <td height="100%" align="center"  style=" border-right:#000 1px solid;border-bottom: 0px solid #000;font-size:12px;">  <?php if ($this->_tpl_vars['order']['goodsarr'][4]['goods_qty']): ?> Accessories 配件 <?php echo $this->_tpl_vars['order']['goodsarr'][4]['goods_sn']; ?>
 <?php echo $this->_tpl_vars['order']['goodsarr'][4]['location'];  else: ?> &nbsp; <?php endif; ?> </td>
             <td align="center"  style=" border-right:#000 1px solid;border-bottom: 0px solid #000;"> <?php if ($this->_tpl_vars['order']['goodsarr'][4]['goods_qty']): ?>   0.01 <?php else: ?> &nbsp; <?php endif; ?>  </td>
             <td align="center"  style=" border-right:#000 1px solid;border-bottom: 0px solid #000;"> <?php if ($this->_tpl_vars['order']['goodsarr'][4]['goods_qty']): ?>   1<?php else: ?> &nbsp; <?php endif; ?>  </td>
              <td align="center"  style=" "> <?php if ($this->_tpl_vars['order']['goodsarr'][4]['goods_qty']): ?>  China <?php else: ?> &nbsp; <?php endif; ?>  </td>
          </tr>
          <?php if ($this->_tpl_vars['xx'] > 6): ?>
              <tr>
                 <td align="center"  style=" border-right:#000 1px solid;border-bottom: 0px solid #000;"> <?php if ($this->_tpl_vars['order']['goodsarr'][5]['goods_qty']): ?>  6 <?php else: ?> &nbsp; <?php endif; ?>   </td>
                 <td align="center"  style=" border-right:#000 1px solid;border-bottom: 0px solid #000;"> <?php if ($this->_tpl_vars['order']['goodsarr'][5]['goods_qty']): ?> <?php echo $this->_tpl_vars['order']['goodsarr'][5]['goods_qty']; ?>
 <?php else: ?> &nbsp; <?php endif; ?></td>
                 <td height="100%" align="center"  style=" border-right:#000 1px solid;border-bottom: 0px solid #000;font-size:12px;">  <?php if ($this->_tpl_vars['order']['goodsarr'][5]['goods_qty']): ?> Accessories 配件 <?php echo $this->_tpl_vars['order']['goodsarr'][5]['goods_sn']; ?>
 <?php echo $this->_tpl_vars['order']['goodsarr'][5]['location']; ?>
 <b style='color:red;font-size:12px;'>需要扫描</b><?php else: ?> &nbsp; <?php endif; ?> </td>
                 <td align="center"  style=" border-right:#000 1px solid;border-bottom: 0px solid #000;"> <?php if ($this->_tpl_vars['order']['goodsarr'][5]['goods_qty']): ?>   0.01 <?php else: ?> &nbsp; <?php endif; ?>  </td>
                 <td align="center"  style=" border-right:#000 1px solid;border-bottom: 0px solid #000;"> <?php if ($this->_tpl_vars['order']['goodsarr'][5]['goods_qty']): ?>   1<?php else: ?> &nbsp; <?php endif; ?>  </td>
                  <td align="center"  style=" "> <?php if ($this->_tpl_vars['order']['goodsarr'][5]['goods_qty']): ?>  China <?php else: ?> &nbsp; <?php endif; ?>  </td>
              </tr>
          <?php else: ?>
              <tr>
                 <td align="center"  style=" border-right:#000 1px solid;border-bottom: 0px solid #000;"> <?php if ($this->_tpl_vars['order']['goodsarr'][5]['goods_qty']): ?>  6 <?php else: ?> &nbsp; <?php endif; ?>   </td>
                 <td align="center"  style=" border-right:#000 1px solid;border-bottom: 0px solid #000;"> <?php echo $this->_tpl_vars['order']['goodsarr'][5]['goods_qty']; ?>
&nbsp; </td>
                 <td height="100%" align="center"  style=" border-right:#000 1px solid;border-bottom: 0px solid #000;font-size:12px;">  <?php if ($this->_tpl_vars['order']['goodsarr'][5]['goods_qty']): ?> Accessories 配件 <?php echo $this->_tpl_vars['order']['goodsarr'][5]['goods_sn']; ?>
 <?php echo $this->_tpl_vars['order']['goodsarr'][5]['location'];  else: ?> &nbsp; <?php endif; ?> </td>
                 <td align="center"  style=" border-right:#000 1px solid;border-bottom: 0px solid #000;"> <?php if ($this->_tpl_vars['order']['goodsarr'][5]['goods_qty']): ?>   0.01 <?php else: ?> &nbsp; <?php endif; ?>  </td>
                 <td align="center"  style=" border-right:#000 1px solid;border-bottom: 0px solid #000;"> <?php if ($this->_tpl_vars['order']['goodsarr'][5]['goods_qty']): ?>   1<?php else: ?> &nbsp; <?php endif; ?>  </td>
                  <td align="center"  style=" "> <?php if ($this->_tpl_vars['order']['goodsarr'][5]['goods_qty']): ?>  China <?php else: ?> &nbsp; <?php endif; ?>  </td>
              </tr>
          ...
          <tr>
            ...
            <td align="center"  style="border-right:#000 1px solid; border-top: #000 1px solid;"><strong> <?php echo $this->_tpl_vars['xx']; ?>
 </strong>&nbsp;</td>
            <td align="left"  style="border-top: #000 1px solid; "><div style=" font-size:10px">Total Gross Weight (Kg.):</div></td>
            <td align="center"  style=" border-right:#000 1px solid;border-top: #000 1px solid; "> <?php echo $this->_tpl_vars['xx']*0.01; ?>
 </td>
            <td align="center"  style= "border-right:#000 1px solid; border-top: #000 1px solid;"> <?php echo $this->_tpl_vars['xx']*1; ?>
 </td>
...
<?php elseif ($this->_tpl_vars['type'] == 169):  $_from = $this->_tpl_vars['orders']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['orderitem'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['orderitem']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['order']):
        $this->_foreach['orderitem']['iteration']++;
?>
