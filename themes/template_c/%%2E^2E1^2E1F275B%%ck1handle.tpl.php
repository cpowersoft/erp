<?php /* Smarty version 2.6.14, created on 2015-09-08 11:01:31
         compiled from order/ck1handle.tpl */ ?>
...
<script type="text/javascript" src="js/order/ck1handle.js"></script>
...
',
		handleURL:'index.php?model=order&action=updateck1',
		completeURL:'index.php?model=order&action=completeck1',
		listURL:'index.php?model=order&action=Getck1handle',
		windowTitle:'高级搜索',
		action:user_action,
		windowWidth:320,
		windowHeight:345,
