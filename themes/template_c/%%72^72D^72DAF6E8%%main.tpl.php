<?php /* Smarty version 2.6.14, created on 2015-08-10 10:17:12
	...
	items:[{
		...
		items:[{
				...
				{	
...
</span></td><th width="110px;">账户状态：</th><td width="60px;"> <span id="ctl00_ContentPlaceHolder1_lblsuaccount">  <?php if ($this->_tpl_vars['eff_time'] == 'success'): ?><a style="color:#ec870e;font-size:15px;font-weight:bold;" href="javascript:void(0)"> 正常使用 </a><?php else: ?> <a style="color:#ec870e;font-size:15px;font-weight:bold;" href="javascript:void(0)">已过期  </a><?php endif;  echo $this->_tpl_vars['cash']; ?>
</span></td><td width="80px"><p><img src="themes/default/images/newico.gif" /></p></td></tr><tr><th>客户编号：</th><td><p><span id="ctl00_ContentPlaceHolder1_lblrushipcode">CNG74149</span>&nbsp;&nbsp;</p></td><th>  </th><td></td>  <td><p>  </p></td></tr><tr><th>发货标识：</th><td><p><span id="ctl00_ContentPlaceHolder1_lblsupin"><?php echo $this->_tpl_vars['user']['frist_name_en']; ?>
</span>&nbsp;&nbsp;(&nbsp;<a>First Name</a>&nbsp;)<?php if ($this->_tpl_vars['user']['frist_name_en'] == ""): ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:void(0)"onclick="newTab(\'clientinfo\',\'修改个人信息\',\'index.php?model=system&action=clientinfo\')">完善个人信息</a><?php endif; ?></td><td><strong></strong>&nbsp;<span id="ctl00_ContentPlaceHolder1_lblsuusaccount"></span></td><td><p></p></td></tr><tr><th>上次登录：</th><td><p><span><a href="javascript:void(0)"><span id="ctl00_ContentPlaceHolder1_lblsupoints"><?php echo $this->_tpl_vars['last_login']; ?>
</span></a></span></p></td><td><strong></strong>&nbsp;<span id="ctl00_ContentPlaceHolder1_lblusdcard"></span></td><td><p></p></td></tr></table></div></div>'
				},{	
					border:false,
					columnWidth:.99,
					xtype:'panel',
					...
					collapsible : false,
					startCollapsed: true,
					html:'<div class="memberIndexStatistics radius"><div class="memberIndexStatisticsTitle topleftandrightradius"><ul><li style="color:#626262">我的订单</li></ul></div><div class="memberIndexStatisticsContent"><ul><li><span class="fr">(<a  onclick="newTab(\'stock\',\'当前库存\',\'index.php?model=inventory\')" href="javascript:void(0)"><span><?php echo $this->_tpl_vars['kucun']; ?>
</span></a>)</span>我的库存</li><li><span class="fr">(<a href="javascript:void(0)"onclick="newTab(\'tishi7\',\'待审核订单\',\'index.php?model=order&action=servicecheck\')"><span><?php echo $this->_tpl_vars['num2']; ?>
</span></a>)</span>等待审核</li><li><span class="fr">(<a href="javascript:void(0)"onclick="newTab(\'tishi8\',\'待处理订单\',\'index.php?model=order&action=orderhandle\')"><span><?php echo $this->_tpl_vars['num4']; ?>
</span></a>)</span>等待处理</li><li><span class="fr">(<a href="javascript:void(0)"onclick="newTab(\'tishi9\',\'捡货订单\',\'index.php?model=order&action=shippinghandle\')"><span><?php echo $this->_tpl_vars['num6']; ?>
</span></a>)</span>捡货订单</li><li><span class="fr">(<a href="javascript:void(0)"onclick="newTab(\'tishi9\',\'已发货订单\',\'index.php?model=order&action=shippinghandle\')"><span><?php echo $this->_tpl_vars['num7']; ?>
</span></a>)</span>已经发货</li><li><span class="fr">(<a href="javascript:void(0)"><span>0</span></a>)</span>缺货订单</li></ul><span class="clearfix"></span></div></div><div class="memberIndexStatistics radius"style="margin-left:10px;"><div class="memberIndexStatisticsTitle topleftandrightradius"><ul><li style="color:#626262">当天订单</li></ul></div><div class="memberIndexStatisticsContent"><ul><?php $_from = $this->_tpl_vars['shippingnum']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['shippingitem'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['shippingitem']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['shipping']):
        $this->_foreach['shippingitem']['iteration']++;
 if ($this->_tpl_vars['shipping']['num'] > 0): ?><li><span class="fr">(<a href="javascript:void(0)"><span><?php echo $this->_tpl_vars['shipping']['num']; ?>
</span></a>)</span><?php echo $this->_tpl_vars['shipping']['name']; ?>
:</li><?php else: ?><li><span class="fr">(<a href="javascript:void(0)"><span>0</span></a>)</span>当天发货:</li><?php endif;  endforeach; endif; unset($_from); ?></ul><span class="clearfix"></span></div></div><div class="memberIndexFAQ radius"><div class="memberIndexTitle2"> 常见问题</div><div class="memberIndexFAQInfo memberIndexIconInfo" ><div style="float:left;"><ul><li><a href="javascript:void(0)"onclick="newTab(\'ask2\',\'常见问题\',\'index.php?model=helps&page=0\')">物流发货</a></li><li><a href="javascript:void(0)"onclick="newTab(\'ask2\',\'常见问题\',\'index.php?model=helps&page=2\')">Amazon相关</a></li><li><a href="javascript:void(0)"onclick="newTab(\'ask2\',\'常见问题\',\'index.php?model=helps&page=4\')">Aliexpress相关</a></li><li><a href="javascript:void(0)"onclick="newTab(\'ask2\',\'常见问题\',\'index.php?model=helps&page=6\')">EBay相关</a></li></ul></div><div style="float:right;"><ul ><li><a href="javascript:void(0)"onclick="newTab(\'ask2\',\'常见问题\',\'index.php?model=helps&page=1\')">产品业务</a></li><li><a href="javascript:void(0)"onclick="newTab(\'ask2\',\'常见问题\',\'index.php?model=helps&page=3\')">客户服务</a></li><li><a  href="javascript:void(0)"onclick="newTab(\'ask2\',\'常见问题\',\'index.php?model=helps&page=5\')">投诉建议</a></li><li><a href="javascript:void(0)"onclick="newTab(\'ask2\',\'常见问题\',\'index.php?model=helps&page=7\')">系统知识</a></li></ul></div></div></div>'
				}]
				  },{
					style:'margin:2 0',
					layout:'column',
					items:[
				{
					...
					items:[{
						...
						border:false,
						startCollapsed: true,
						html:'<div class="memberIndexShare radius"><div class="memberIndexTitle topleftandrightradius"  style="position:relative;">物流信息</div><div class="memberIndexStatisticsContent"><div style="padding:3px;border-bottom: 1px solid #D7D7D7;"><?php echo $this->_tpl_vars['track']['date']; ?>
系统查询发货订单情况<font style="color: #FF6300;float:right;font-weight:bold;margin-right:20px;cursor:pointer;" onclick="newTab(\'tishi19\',\'物流详情\',\'index.php?model=main&action=TrackDetail\')">查看详情</font></div><ul style="margin-top:10px"><li><span class="fr">(<a href="javascript:void(0)"><span><?php echo $this->_tpl_vars['track']['Shipment']; ?>
</span></a>)</span>查询不到</li><li><span class="fr">(<a href="javascript:void(0)"><span><?php echo $this->_tpl_vars['track']['Shipment']; ?>
</span></a>)</span>运输途中</li><li><span class="fr">(<a href="javascript:void(0)"><span><?php echo $this->_tpl_vars['track']['Arrived']; ?>
</span></a>)</span>到达待取</li><li><span class="fr">(<a href="javascript:void(0)"><span><?php echo $this->_tpl_vars['track']['Delivered']; ?>
</span></a>)</span>成功签收</li><li><span class="fr">(<a href="javascript:void(0)"><span><?php echo $this->_tpl_vars['track']['Returned']; ?>
</span></a>)</span>物件退回</li><li><span class="fr">(<a href="javascript:void(0)"><span><?php echo $this->_tpl_vars['track']['Overseas']; ?>
</span></a>)</span>运往当地</li></ul> <div style="clear:both;font-size:11px;padding:3px;color:#CCC">提示：状态为签收完成的订单将自动变为已完成订单。</div></div></div>'
						//items:[listView2]
					}]
				},{
                    columnWidth:.32,
...
function newTab(id,text,url) {
      ...
      if('<?php echo $this->_tpl_vars['eff_time']; ?>
' == 'error')url = 'http://www.cpowersoft.com/blog/contact_us';
...
Ext.onReady(function(){
 ...
 ></a><ul style="float:right;margin:0;padding:0;list-style:none; background-image:url(themes/default/images/topbg.jpg); background-repeat:no-repeat;background-position:85% 50%;margin-top:-9px"><li style="line-height:40px;text-align:right">欢迎您:&nbsp;&nbsp;<b style="color:#F15628;"><?php echo $_SESSION['admin_name']; ?>
	  ...
	  <?php $_from = $this->_tpl_vars['trees']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach["treeitem}"] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach["treeitem}"]['total'] > 0):
    foreach ($_from as $this->_tpl_vars['tree']):
        $this->_foreach["treeitem}"]['iteration']++;
?>
        tree.add(Ext.create('Ext.tree.Panel', {
            title: '<?php echo $this->_tpl_vars['tree']['text']; ?>
',
            lines:true,
            autoLoad:false, 
            autoScroll:true,
            ...
            store: Ext.create('Ext.data.TreeStore', {
                ...
                proxy: {
                    type: 'ajax',
                    url: 'index.php?model=main&action=Treeson&node=<?php echo $this->_tpl_vars['tree']['id']; ?>
',
                },root: {
                text: 'Root',
                id: '<?php echo $this->_tpl_vars['tree']['id']; ?>
',
                draggable:false
                 }
            }),
