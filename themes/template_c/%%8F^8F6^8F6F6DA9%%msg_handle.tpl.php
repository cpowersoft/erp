<?php /* Smarty version 2.6.14, created on 2015-09-10 11:18:03
         compiled from aliexpress/msg_handle.tpl */ ?>
...
var menu_store = [<?php echo $this->_tpl_vars['menu_store']; ?>
];
...
<?php $_from = $this->_tpl_vars['menu_store']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['mstore'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['mstore']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['menu']):
        $this->_foreach['mstore']['iteration']++;
?>
    menu_account.push({
       title:'<?php echo $this->_tpl_vars['menu']['title']; ?>
',
       url: '<?php echo $this->_tpl_vars['menu']['url']; ?>
',
       id:'<?php echo $this->_tpl_vars['menu']['id']; ?>
',
       type:'<?php echo $this->_tpl_vars['menu']['type']; ?>
'
    });
...
',         
                    ...
                    id: 'end',
                    format:'Y-m-d',
                    value:'<?php echo $this->_tpl_vars['today']; ?>
',
                    maxValue:'<?php echo $this->_tpl_vars['today']; ?>
',
                    allowBlank:false,         
