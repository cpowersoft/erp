<?php /* Smarty version 2.6.14, created on 2015-08-10 10:17:29
         compiled from order/loadorder.tpl */ ?>
...
'
	        ...
	        store: Ext.create('Ext.data.ArrayStore',{
	             fields: ["id", "account_name"],
	             data: [<?php echo $this->_tpl_vars['amazonaccount']; ?>
]
	        }),
	        valueField :"id",
	        displayField: "account_name",
...
'
	        ...
	        store: Ext.create('Ext.data.ArrayStore',{
	             fields: ["id", "account_name"],
	             data:[<?php echo $this->_tpl_vars['zcaccount']; ?>
]
	        }),
	        valueField :"id",
	        displayField: "account_name",
...
'
	        ...
	        store: Ext.create('Ext.data.ArrayStore',{
	             fields: ["id", "account_name"],
	             data:[<?php echo $this->_tpl_vars['tbaccount']; ?>
]
	        }),
	        valueField :"id",
	        displayField: "account_name",
    ...
    var paypal = Ext.create('Ext.form.Panel',{
        ...
        items: [{
			...
			labelWidth:80,
			format:'Y-m-d',
			value:'<?php echo $this->_tpl_vars['dday']; ?>
',
			maxValue:'<?php echo $this->_tpl_vars['today']; ?>
'
		},{
...
'
	        ...
	        store: Ext.create('Ext.data.ArrayStore',{
	             ...
	             data: [<?php echo $this->_tpl_vars['paccount']; ?>
]
	        }),
...
'
                                ...
                                store: Ext.create('Ext.data.ArrayStore',{
                                     fields: ["id", "account_name"],
                                     data:[<?php echo $this->_tpl_vars['aliaccount']; ?>
]
                                }),
                                valueField :"id",
                                displayField: "account_name",
...
'
								...
								store: Ext.create('Ext.data.ArrayStore',{
									 fields: ["id", "account_name"],
									 data:[<?php echo $this->_tpl_vars['dhaccount']; ?>
]
								}),
								valueField :"id",
								displayField: "account_name",
...
'
            ...
            store: Ext.create('Ext.data.ArrayStore',{
                 fields: ["id", "account_name"],
                 data:[<?php echo $this->_tpl_vars['mgaccount']; ?>
]
            }),
            valueField :"id",
            displayField: "account_name",
