<?php /* Smarty version 2.6.14, created on 2015-09-09 11:22:42
         compiled from system/clientinfo.tpl */ ?>
...
.memberCommonBtn{background: url("themes/default/images/linkBtn.jpg") repeat-x;color: #522201;display: inline-block;
    ...
    <div class="memberMyInfo" style="height:auto;">
        ...
        <tr>
            ...
            <td><label id="ruNickname"/><?php echo $_SESSION['admin_name']; ?>
</td>
        </tr>         
         <tr>
            <th style="width:190px;" >您的中文姓名：</th>
            <td><input type="text" id="cn_name" class="memberCommonInput" value="<?php echo $this->_tpl_vars['user']['cn_name']; ?>
" /><span style=" color:#ff0000">*</span></td>
        </tr>
        <tr>
            <th style="width:190px;" >您的英文姓名：</th>
            <td><input type="text" id="frist_name_en" class="memberCommonInput" value="<?php echo $this->_tpl_vars['user']['frist_name_en']; ?>
" /><input type="text" id="last_name_en" class="memberCommonInput" value="<?php echo $this->_tpl_vars['user']['last_name_en']; ?>
" />&nbsp;<span style=" color:#ff0000">*</span></td>
        </tr>
         <tr>
            <th style="width:190px;" >您的性别：</th>
            <td><select id="sex" class="memberCommonInput" >
            		<option value="1" <?php if ($this->_tpl_vars['user']['sex'] == 1): ?> selected="selected" <?php endif; ?> >男</option>
                    <option value="2" <?php if ($this->_tpl_vars['user']['sex'] == 2): ?> selected="selected" <?php endif; ?> >女</option>
                </select>
            </td>
        </tr>
         ...
         <tr>
            ...
            <td><input type="text" id="address" maxlength="200" style=" width:305px;" class="memberCommonInput" value="<?php echo $this->_tpl_vars['user']['address']; ?>
"  /><span style=" color:#ff0000">*</span><br />
            </td>
        </tr>
        <tr>
            <th style="width:190px;" ></th>
            <td><input type="text" id="address2"  maxlength="200" style=" width:305px;" class="memberCommonInput" value="<?php echo $this->_tpl_vars['user']['address2']; ?>
"/></td>
        </tr>
         <tr>
            <th style="width:190px;" >身份证号：</th>
            <td><input type="text" id="cart_no" maxlength="18" class="memberCommonInput" value="<?php echo $this->_tpl_vars['user']['cart_no']; ?>
"  /><a href="#">输入后不可修改！</a></td>
        </tr>
        <tr>
            <th style="width:190px;" >接收通知邮箱：</th>
            <td><label id="sent_email" style="color:Blue;"><?php echo $this->_tpl_vars['user']['sent_email']; ?>
</label>
            <a id="linkEmail" style="margin-left:20px;margin-right:20px;color:Blue;cursor:pointer;" onclick="openemailwin()">修改</a>
            <?php if ($this->_tpl_vars['user']['email_is_checking'] == 0): ?>
...
function openemailwin(){
	...
	win.show();
         ...
         <tr>
            ...
            <td><input type="text" id="m_phone_no" maxlength="15" class="memberCommonInput" value="<?php echo $this->_tpl_vars['user']['m_phone_no']; ?>
"  /><span style=" color:#ff0000">*</span></td>
        </tr>
        <tr>
            <th style="width:190px;" >固定电话：</th>
            <td><input type="text" id="phone" maxlength="22" class="memberCommonInput" value="<?php echo $this->_tpl_vars['user']['phone']; ?>
"  /></td>
        </tr>
        <tr>
            <th style="width:190px;" >邮政编码：</th>
            <td><input type="text" id="zipcode" maxlength="6" class="memberCommonInput" value="<?php echo $this->_tpl_vars['user']['zipcode']; ?>
"  /><span style=" color:#ff0000">*</span></td>
        </tr>
        <tr>
            <th style="width:190px;" >个人博客：</th>
            <td><input type="text" id="blog_address" maxlength="60" class="memberCommonInput" value="<?php echo $this->_tpl_vars['user']['blog_address']; ?>
"  /></td>
        </tr>
        <tr>
            <th style="width:190px;" >腾讯QQ：</th>
            <td><input type="text" id="qq_no" maxlength="20" class="memberCommonInput" value="<?php echo $this->_tpl_vars['user']['qq_no']; ?>
"  /></td>
        </tr>
        <tr>
            <th style="width:190px;" >M&nbsp;S&nbsp;&nbsp;N：</th>
            <td><input type="text" id="msn_no" maxlength="60" class="memberCommonInput" value="<?php echo $this->_tpl_vars['user']['msn_no']; ?>
" /></td>
        </tr>
        <tr>
            <th style="width:190px;" >备注信息：</th>
            <td><textarea id="info_note"  rows="6" cols="60" class="memberCommonInput" value="<?php echo $this->_tpl_vars['user']['info_note']; ?>
" ></textarea></td>
        </tr>
        <tr>
            <th>&nbsp;</th>
