<?php /* Smarty version 2.6.14, created on 2015-08-18 10:14:08
         compiled from order/eubhandle1.tpl */ ?>
...
<script type="text/javascript" src="js/order/eubhandle1.js"></script>
...
salechannel.push(['0','所有渠道']);
	var viewport = Ext.create('Ext.ux.depotmanagerView',{
		...
		step:'eubhandle',
		listURL:'index.php?model=order&action=Geteubhandle1',
		windowTitle:'高级搜索',
		action:user_action,
		windowWidth:320,
		windowHeight:345,
