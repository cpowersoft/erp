    ...
    initComponent: function(){
        ...
        Ext.apply(this, {
            ...
            tpl: Ext.create('Ext.XTemplate',
                ...
                '<textarea style="font-size:12px;width:100%;border: 1px solid #15428b;" id="answer" rows = "8"></textarea></div>',
...
Ext.define('FeedViewer.App', {
    ...
    initComponent: function(){
        ...
        Ext.define('FeedItem', {
            extend: 'Ext.data.Model',
            fields: ['message_id', 'title','author', 'pubDate','link','track_info','msg_type','messageType','order_sn', 'description','account_name','account_id','orderId','content','readed']
        });
