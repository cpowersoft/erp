...
<script type="text/javascript" src="js/order/ywhandle.js"></script>
...
salechannel.push(['0','所有渠道']);
    var viewport = Ext.create('Ext.ux.depotmanagerView',{
        headers:['print_status','order_status','paid_time','PrepareTime','order_sn','paypalid','goods','shipping_id','track_no','eubpdf','Sales_account_id','country','ShippingService'],
        ...
        listURL:'index.php?model=order&action=getywhandler',
        windowTitle:'高级搜索',
        action:user_action,
        windowWidth:320,
        windowHeight:345,
