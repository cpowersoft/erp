...
<script type="text/javascript" src="js/order/uspshandle.js"></script>
...
salechannel.push(['0','所有渠道']);
	var viewport = Ext.create('Ext.ux.depotmanagerView',{
		...
		action:user_action,
		url:'<!--{$url}-->',
		handleURL:'index.php?model=order&action=updateusps',
		listURL:'index.php?model=order&action=Getuspshandle',
		windowTitle:'高级搜索',
		windowWidth:320,
		windowHeight:345,
		pagesize:15
