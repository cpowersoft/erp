...
<!--{/foreach}-->
      <!--{elseif $type eq 161}--><!--中国邮政航空小包挂号(广东)A4带捡货单-->
<!--{foreach from =$orders item = order name=orderitem}-->
...
<tr>
    <td valign="top"  style="width:88mm;height:85mm;border-left:1px;border: 1px;border-bottom-style: dashed;border-left-style: dashed;border-right-style: dashed;border-top-style: dashed;border-color: #000;padding:5;padding-bottom:0;">
        <table cellpadding="5" cellspacing="0" class="tabBq1">
            <tr>
                <td valign="top" align="left" style="border:0px;padding: 0;" colspan="2">
                <B>FROM:&nbsp;YZJ</B><p style="font-size:11px;font-family:'PT Sans',Verdana,Tahoma,Arial,sans-serif;">14 -ROOM 4102 SHENZHEN POSTAL EXPRESS SUPERVISION CENTER, JUNCTION OF QIAOXIZNG RD.&SHENYUN RD.,OCT NORTH,SHENZHEN</p><br>
              </td>  
            </tr>
                <tr>
                <td valign="top" colspan="2" style="height:35mm;padding-left:5px" align="left">
              ...
              <tr valign="bottom">
              <td valign="bottom" style="border: 0px; height:30mm;" colspan="2" width="100%">

                <table width="100%" cellpadding="1" cellspacing="1">
                    <tr>
                        <td style="padding-left: 3px" align="center"> 
                            <table cellpadding="0" cellspacing="0">
                                <tr><td align="center" style="font-size: 13px"><b><!--{$order.order_sn}--></b></td></tr>
                                <tr><td><img src="common/lib/barcodegen/html/image.php?filetype=PNG&dpi=72&scale=1&rotation=0&font_family=0&font_size=8&text=<!--{$order.order_sn}-->&thickness=55&start=NULL&code=BCGcode128"></td></tr>
                            </table>
                        </td>
                    </tr>
                    <tr>
                        <td style="font-size:10px; font-family:sans-serif;" align="center">中国邮政航空小包挂号(广东)&nbsp;<!--{$order.order_sn}-->&nbsp;RefNo:<!--{$order.paypalid}--></td>
                    </tr>
                </table>
              </td>
    </tr>
    ...
    <table cellpadding="0" cellspacing="0" style="font-size: 11px;font-family:Arial,sans-serif;">
        ...
        <tr>
            <td style="padding-left:5px;" colspan="2">
                (15)Date and sender's signature</span> <div style="text-align:right;padding-right:20px;font-style: italic;font-weight:bold">HLY YZJ</div>
            </td>
        </tr>
    </table>
</td>
...
<div style="margin-left: 25px;">
    <table style="border: 1px solid #000;width: 193mm;" cellpadding="0" cellspacing="0">
      <tr>
         <td width="35%"  valign="top" style="border-right:#000000 1px solid; font-size: 10px;">
            <div style="text-align:center;margin-top:10px;"><img src="common/lib/barcodegen/html/image.php?filetype=PNG&dpi=72&scale=1&rotation=0&font_family=Arial.ttf&font_size=8&text=<!--{$order.paypalid}-->&thickness=30&start=NULL&code=BCGcode128"></div><br />
            &nbsp;&nbsp;<!--{$smarty.now|date_format:'%Y-%m-%d'}--><br />
            &nbsp;&nbsp;物流方式:<!--{$order.ShippingService}--><br />
            &nbsp;&nbsp;备注:<!--{$order.pay_note}-->
         </td>
         <td valign="top">
            <table width="100%" height="100%" align="center" border="0" cellspacing="0" cellpadding="0" style="word-break: break-all;break-all;position:relative; font-size: 10px;">
               <tr style="height: 25px;" valign="middle" align="center">
                  <td style="border-bottom: 1px solid #000;" width="20%" valign="middle">
                      图片
                  </td>
                  <td style="border-bottom: 1px solid #000;border-left:1px solid #000;" width="55%"  valign="middle">
                      产品名称 
                  </td>
                  <td style="border-bottom: 1px solid #000;border-left:1px solid #000;" width="15%"  valign="middle">
                      SKU 
                  </td>
                  <td style="border-bottom: 1px solid #000;border-left:1px solid #000;" width="10%"  valign="middle">
                      数量 
                  </td> 
               </tr>
               <!--{foreach from =$order.goodsarr item = goods name=goodsitem}}-->
               <tr style="height:60px;" valign="middle" align="center">
                  <td style="border-bottom: 1px solid #000;" valign="top">
                      <img src="<!--{$goods.goods_img}-->" width="55px"/>
                  </td>
...
<!--{elseif $type eq 162}--><!--香港小包挂号A4带捡货单-->
<!--{foreach from =$orders item = order name=orderitem}-->
<table cellspacing="25" cellpadding="0" style="width:205mm">
<tr>
    <td valign="top"  style="width:88mm;height:85mm;border-left:1px;border: 1px;border-bottom-style: dashed;border-left-style: dashed;border-right-style: dashed;border-top-style: dashed;border-color: #000;padding:5;padding-bottom:0;">
...
<!--{elseif $type eq 163}--><!--瑞典小包挂号A4带捡货单-->
<!--{foreach from =$orders item = order name=orderitem}-->
<table cellspacing="25" cellpadding="0" style="width:205mm">
<tr>
    <td valign="top"  style="width:88mm;height:85mm;border-left:1px;border: 1px;border-bottom-style: dashed;border-left-style: dashed;border-right-style: dashed;border-top-style: dashed;border-color: #000;padding:5;padding-bottom:0;">
...
<!--{elseif $type eq 164}--><!--瑞士小包挂号(三区)A4带拣货单-->
<!--{foreach from =$orders item = order name=orderitem}-->
<table cellspacing="25" cellpadding="0" style="width:205mm">
<tr>
    <td valign="top"  style="width:88mm;height:85mm;border-left:1px;border: 1px;border-bottom-style: dashed;border-left-style: dashed;border-right-style: dashed;border-top-style: dashed;border-color: #000;padding:5;padding-bottom:0;">
...
<!--{elseif $type eq 165}--><!--新加坡小包挂号(五区)A4带拣货单-->
<!--{foreach from =$orders item = order name=orderitem}-->
 <table cellspacing="25" cellpadding="0" style="width:205mm">
<tr>
    <td valign="top"  style="width:88mm;height:85mm;border-left:1px;border: 1px;border-bottom-style: dashed;border-left-style: dashed;border-right-style: dashed;border-top-style: dashed;border-color: #000;padding:5;padding-bottom:0;">
