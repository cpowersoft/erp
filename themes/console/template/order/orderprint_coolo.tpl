...
<tr>
    <td valign="top"  style="width:88mm;height:85mm;border-left:1px;border: 1px;border-bottom-style: dashed;border-left-style: dashed;border-right-style: dashed;border-top-style: dashed;border-color: #000;padding:5;padding-bottom:0;">
        <div class="printSource" style="float: left; margin-left: 4px; margin-top: 10px;margin-right: 4px; width: 355px; height: 350px;">
            ...
            <div style="width: 320px; text-align: center; margin-top: 2px; height: 65px; font-family: Arial;"><span><img src='common/lib/barcodegen/html/image.php?filetype=PNG&dpi=72&scale=1&rotation=0&font_family=0&font_size=0&text=<!--{$order.track_no}-->&thickness=45&start=NULL&code=BCGcode128' style='width: 250px;height:40px;'/></span><br />
            <b><!--{$order.track_no}--></b></div>
...
<td valign="top" style="width:88mm;height:85mm;border-left:1px;border: 1px;border-bottom-style: dashed;border-left-style: dashed;border-right-style: dashed;border-top-style: dashed;border-color: #000;">
        ...
        <div style="margin-left: 2px;display: block; padding-top: 0px; margin-top: 10px; width: 322px; height: 350px; border-color: White;" class="ShowDeclaration" id="divA_R0362OI14080200007">
                ...
                <div style="width: 320px; height: 40px; font-size: 10px; font-weight: normal;">
                    ...
                    <div style="float: left; width: 180px; border: 1px #000000 solid; border-top: 0px;  border-left: 0px; border-bottom: 0px; text-align: center; height: 40px;">LED&nbsp;&nbsp;*&nbsp;&nbsp;<!--{$order.total}--><br></div>
                    ...
                    <div style="float: left; width: 60px; text-align: center; height: 40px;">USD <!--{math equation="x / y" x=10 y=$order.total assign="price"}--> <!--{ $price|string_format:"%.2f"}--></div>
    ...
    <table style="width: 193mm;" cellpadding="0" cellspacing="0">
      <tr>
        <td width="15%" style="border-top: 1px solid #000;border-left: 1px solid #000;border-bottom: 1px solid #000;">
            <div style="text-align:center;margin-top:10px;"><img src="common/lib/barcodegen/html/image.php?filetype=PNG&dpi=72&scale=1&rotation=0&font_family=Arial.ttf&font_size=8&text=<!--{$order.paypalid}-->&thickness=30&start=NULL&code=BCGcode128"></div>        
        </td> 
         <td valign="top">
...
<div <!--{if !$smarty.foreach.orderitem.last && !$smarty.foreach.orderitem.first && ($smarty.foreach.orderitem.index+1) % 2 == 0}-->class="pagebreak"<!--{/if}-->></div>
            
<!--{/foreach}-->
<!--{elseif $type eq 171}--><!--中国邮政航空天津小包A4-->
<!--{foreach from =$orders item = order name=orderitem}-->
<table cellspacing="25" cellpadding="0" style="width:205mm">
<tr>
    <td valign="top"  style="width:88mm;height:85mm;border-left:1px;border: 1px;border-bottom-style: dashed;border-left-style: dashed;border-right-style: dashed;border-top-style: dashed;border-color: #000;padding:5;padding-bottom:0;">
        <div class="printSource" style="float: left; margin-left: 4px; margin-top: 10px;margin-right: 4px; width: 355px; height: 350px;">
            ...
            <div style="margin-left: 30px; margin-top: -14px; height: 115px;"><!--{$order.consignee}--><br />
             <!--{$order.street1}-->&nbsp; <!--{$order.street2}-->  <br />
            <!--{$order.city}-->,<!--{if $order.state}--><!--{$order.state}-->,<!--{/if}--> &nbsp;<br />
            <!--{$order.country}--> <span style="padding:0px;margin:0px; font-family: Arial;font-size:18px"> (<!--{$order.Cncountry}-->)
                                    </span></div>
...
<div style="margin-left: 25px;">
    <table style="width: 193mm;" cellpadding="0" cellspacing="0">
      <tr>
        <td width="15%" style="border-top: 1px solid #000;border-left: 1px solid #000;border-bottom: 1px solid #000;">
            <div style="text-align:center;margin-top:10px;"><img src="common/lib/barcodegen/html/image.php?filetype=PNG&dpi=72&scale=1&rotation=0&font_family=Arial.ttf&font_size=8&text=<!--{$order.paypalid}-->&thickness=30&start=NULL&code=BCGcode128"></div> 
            <div><!--{$smarty.now|date_format:"%Y-%m-%d %H:%M:%S"}--> </div>      
        </td> 
         <td valign="top">
            <table width="100%" height="100%" align="center" border="0" cellspacing="0" cellpadding="0" style="word-break: break-all;break-all;position:relative; font-size: 10px;">
               <tr style="height: 25px;" valign="middle" align="center">
...
<!--{elseif $type eq 181}--><!--中国邮政航空小包挂号(广东)A4-->
<!--{foreach from =$orders item = order name=orderitem}-->
<table cellspacing="25" cellpadding="0" style="width:205mm">
<tr>
    <td valign="top"  style="width:88mm;height:85mm;border-left:1px;border: 1px;border-bottom-style: dashed;border-left-style: dashed;border-right-style: dashed;border-top-style: dashed;border-color: #000;padding:5;padding-bottom:0;">
...
<!--{elseif $type eq 185}--><!--中国邮政航空小包挂号(广东)A4 报关固定不变-->
<!--{foreach from =$orders item = order name=orderitem}-->
<table cellspacing="25" cellpadding="0" style="width:205mm">
<tr>
    <td valign="top"  style="width:88mm;height:85mm;border-left:1px;border: 1px;border-bottom-style: dashed;border-left-style: dashed;border-right-style: dashed;border-top-style: dashed;border-color: #000;padding:5;padding-bottom:0;">
    ...
    <table style="width: 193mm;" cellpadding="0" cellspacing="0">
      <tr>
        <td width="20%" style="border-top: 1px solid #000;border-left: 1px solid #000;border-bottom: 1px solid #000;">
            <div style="text-align:center;margin-top:10px;"><img src="common/lib/barcodegen/html/image.php?filetype=PNG&dpi=72&scale=1&rotation=0&font_family=Arial.ttf&font_size=8&text=<!--{$order.paypalid}-->&thickness=30&start=NULL&code=BCGcode128"></div> 
            <div style="font-size: 12px;"><!--{$smarty.now|date_format:"%Y-%m-%d %H:%M:%S"}--> </div>             
        </td> 
         <td valign="top">
            <table width="100%" height="100%" align="center" border="0" cellspacing="0" cellpadding="0" style="word-break: break-all;break-all;position:relative; font-size: 10px;">
               <tr style="height: 25px;" valign="middle" align="center">
...
<tr>
    <td valign="top"  style="width:88mm;height:85mm;border-left:1px;border: 1px;border-bottom-style: dashed;border-left-style: dashed;border-right-style: dashed;border-top-style: dashed;border-color: #000;padding:5;padding-bottom:0;">
        ...
        <table width="100%" cellpadding="0" cellspacing="0" class="tabBq1">  
            ...
            <tr>
                <td colspan="2" valign="bottom" style="font-size:10px;border-bottom : 1px solid #000;border-top: 1px solid #000;border-left: 1px solid #000;border-right: 1px solid #000;font-family:sans-serif;" align="center" colspan="2">香港小包挂号&nbsp;<!--{$order.order_sn}-->&nbsp;RefNo:<!--{$order.paypalid}--></td>
            </tr>
    </table>
</td> 
 <td valign="top" style="width:88mm;height:85mm;border-left:1px;border: 1px;border-bottom-style: dashed;border-left-style: dashed;border-right-style: dashed;border-top-style: dashed;border-color: #000;">
...
<tr>
    <td valign="top"  style="width:88mm;height:85mm;border-left:1px;border: 1px;border-bottom-style: dashed;border-left-style: dashed;border-right-style: dashed;border-top-style: dashed;border-color: #000;padding:5;padding-bottom:0;">
        ...
        <table width="100%" cellpadding="0" cellspacing="0" class="tabBq1">  
            ...
            <tr>
                <td colspan="2" valign="bottom" style="font-size:10px;border-bottom : 1px solid #000;border-top: 1px solid #000;border-left: 1px solid #000;border-right: 1px solid #000;font-family:sans-serif;" align="center" colspan="2">瑞典小包挂号&nbsp;<!--{$order.order_sn}-->&nbsp;RefNo:<!--{$order.paypalid}--></td>
            </tr>
    </table>
</td> 
 <td valign="top" style="width:88mm;height:85mm;border-left:1px;border: 1px;border-bottom-style: dashed;border-left-style: dashed;border-right-style: dashed;border-top-style: dashed;border-color: #000;">
...
<!--{elseif $type eq 164}--><!--瑞士小包挂号(三区)A4-->
<!--{foreach from =$orders item = order name=orderitem}-->
<table cellspacing="25" cellpadding="0" style="width:205mm">
<tr>
    <td valign="top"  style="width:88mm;height:85mm;border-left:1px;border: 1px;border-bottom-style: dashed;border-left-style: dashed;border-right-style: dashed;border-top-style: dashed;border-color: #000;padding:5;padding-bottom:0;">
        ...
        <table cellpadding="0" cellspacing="0" class="tabBq1" width="100%">  
            ...
            <tr>
                <td colspan="2" valign="bottom" style="font-size:10px;border-bottom : 1px solid #000;border-top: 1px solid #000;border-left: 1px solid #000;border-right: 1px solid #000;font-family:sans-serif;" align="center" colspan="2">瑞士挂号&nbsp;(三区)<!--{$order.order_sn}-->&nbsp;RefNo:<!--{$order.paypalid}--></td>
            </tr>
    </table>
</td> 
 <td valign="top" style="width:88mm;height:85mm;border-left:1px;border: 1px;border-bottom-style: dashed;border-left-style: dashed;border-right-style: dashed;border-top-style: dashed;border-color: #000;">
...
<tr>
    <td valign="top"  style="width:88mm;height:85mm;border-left:1px;border: 1px;border-bottom-style: dashed;border-left-style: dashed;border-right-style: dashed;border-top-style: dashed;border-color: #000;padding:5;padding-bottom:0;">
        ...
        <table cellpadding="0" cellspacing="0" width="100%" class="tabBq1">  
            ...
            <tr>
                <td colspan="2" valign="bottom" style="font-size:10px;border-bottom : 1px solid #000;border-top: 1px solid #000;border-left: 1px solid #000;border-right: 1px solid #000;font-family:sans-serif;" align="center" colspan="2">新小包挂号&nbsp;<!--{$order.order_sn}-->&nbsp;RefNo:<!--{$order.paypalid}--></td>
            </tr>
    </table>
</td> 
 <td valign="top" style="width:88mm;height:85mm;border-left:1px;border: 1px;border-bottom-style: dashed;border-left-style: dashed;border-right-style: dashed;border-top-style: dashed;border-color: #000;">
...
<!--{elseif $type eq 196}--><!--中国邮政航空小包挂号（广州）A4-->
<!--{foreach from =$orders item = order name=orderitem}-->
<table cellspacing="25" cellpadding="0" style="width:205mm">
<tr>
    <td valign="top"  style="width:88mm;height:85mm;border-left:1px;border: 1px;border-bottom-style: dashed;border-left-style: dashed;border-right-style: dashed;border-top-style: dashed;border-color: #000;padding:5;padding-bottom:0;">
        ...
        <table style="width: 100%;border: 1px #707070 solid; font-family: Arial, Helvetica, sans-serif;
            ...
            <tr>
                <td colspan="4" style="padding-left:5px;padding:5px 0;">
                    ...
                    <span style=" font-family: Arial;font-size: 12px;">TO:</span>
                        ...
                        <!--{$order.city}-->,<!--{if $order.state}--><!--{$order.state}-->,<!--{/if}--> &nbsp;<br />
                        <!--{$order.country}--> 
                        <span style="padding:0px;margin:0px; "> (<!--{$order.Cncountry}-->)</span>
            ...
            <tr>
                <td colspan="2" style="border-bottom: 1px solid #707070;padding:5px 0;">
                    <span style="font-weight: bold; padding-top: 0px; font-family: Arial;">Zip:</span><!--{$order.zipcode}-->
                </td>
                <td colspan="2" style="border-bottom: 1px solid #707070;padding:5px 0;">
                    <span style="font-weight: bold;margin-left: 40px; font-family: Arial;">Tel:</span> <!--{$order.tel}-->
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td colspan="3">
                    <div style="width: 320px; text-align: center; margin-top: 10px; height: 65px; font-family: Arial;"><span><img src='common/lib/barcodegen/html/image.php?filetype=PNG&dpi=72&scale=1&rotation=0&font_family=0&font_size=0&text=<!--{$order.track_no}-->&thickness=45&start=NULL&code=BCGcode128' style='width: 250px;height:40px;'/></span><br />
                    <b><!--{$order.track_no}--></b></div>        
                </td>
            </tr>
            <tr>
...
<!--{elseif $type eq 200}--><!--中国邮政航空小包挂号(华南)A4-->
<!--{foreach from =$orders item = order name=orderitem}-->
<table cellspacing="25" cellpadding="0" style="width:205mm">
<tr>
    <td valign="top"  style="width:88mm;height:85mm;border-left:1px;border: 1px;border-bottom-style: dashed;border-left-style: dashed;border-right-style: dashed;border-top-style: dashed;border-color: #000;padding:5;padding-bottom:0;">
        <div class="printSource" style="float: left; margin-left: 4px; margin-top: 10px;margin-right: 4px; width: 355px; height: 350px;">
            ...
            <span style="margin-left: -15px">Small Packet</span><br />
            <span>BY AIR</span></div>
            <div style="text-align: center; margin-top: 10px; font-size: 14px;font-weight: bold"><!--{$order.countryCode}--> <!--{$order.Cncountry}-->&nbsp;&nbsp;</div>
            <div style="border: 1px #707070 solid; border-top: 0px; clear: both; border-left: 0px;
            border-right: 0px; height: 0px;">&nbsp;</div>
            <div style="width: 320px; height: 30px;">
            ...
            <div style="border: 1px #707070 solid; border-bottom: 0px; border-left: 0px; border-right: 0px; font-family: Arial;
            height: 0px;">
            <div style="width: 320px; margin-top: 5px; font-family: Arial;">Ref No: <!--{$order.paypalid}--></div>
            </div>
            </div>
            </div>
    </td>   
