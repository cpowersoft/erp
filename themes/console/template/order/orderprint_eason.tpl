...
<li><img src="index.php?model=login&action=Barcode&number=<!--{$order.paypalid}-->&height=30"></li>
<li style="width:206px;margin-top:-20px;letter-spacing:4px;margin-left:20px;">*<!--{$order.paypalid}-->*</li>
<li>
<!--{foreach from =$order.goodsarr item = goods name=goodsitem}-->
<b style="font-size:18px"><!--{$goods.goods_sn}--></b>&nbsp;&nbsp;&nbsp;&nbsp;
 <!--{/foreach}-->
</li>
</ul>
</div>
...
<!--地址标签-->
<div style="padding:0px;margin-left:10px;position:relative;top:0.3cm;width:7.2cm;height:8.9cm;border:1px solid #000;font-family:Arial, Helvetica, sans-serif;font-size:12px;" class="pagebreak">
...
<div style="padding:0px;margin:0px;width:7.2cm;position:absolute;top:1.6cm;text-align:center;margin:0px auto;">
                ...
                <table style="padding:0px;margin:0px;border-collapse:collapse;width:100%;margin-top:0cm;border:1px solid #000000;border-top:0px;height:1.7cm;">
                    <tr>
                        <td style="padding:0px;margin:0px;width:3.5cm;font-size:7pt;text-align:left;border-bottom:1px solid #000; ">
                            <b>内件详细名称和数量</b>
                            <br />
                            <b>Quantity and detailed description of contents</b>
                        </td>
                        <td style="padding:2px;    border-right:1px solid #000;    border-bottom:1px solid #000;    border-collapse:collapse;
...
<tr style="padding:0px;margin:0px;height:25px;">
                        ...
                        <td style="padding:2px;    border-right:1px solid #000;       border-collapse:collapse;
                        overflow:hidden;padding:0px;margin:0px;width:1.5cm;font-size:6pt;text-align:center;">
                            <span  contenteditable = "true"><b>$<!--{$goods.Declared_value}--></b></span>
                        </td>
                    </tr>
		    <!--{/foreach}-->
                    <tr>
                        ...
                        overflow:hidden;padding:0px;margin:0px;width:3.5cm;font-size:6pt;text-align:left;">
                            <b>协调系统税则号列和货物原产国（只对商品邮件填写）</b>
                            <br />
                            <b>HS tariff number and country of origin of goods(For commercial items only)</b>
                        </td>
                ...
                <p style="padding:0px;margin:0px;margin-top:3px;font-size:6pt;text-align:left;line-height:9px; font-weight:700">
...
<!--{elseif $type eq 159}--><!-- 中国邮政小包（挂号）18*8-->
<!--{foreach from =$orders item = order name=orderitem}-->
...
<div style="padding:0;margin:5px 0 0 0;text-align:left">
 <div style="font-size:16px"><!--{$order.paypalid}--></div>
<!--{foreach from =$order.goodsarr item = goods name=goodsitem}-->
<b><!--{$goods.goods_sn}--></b>&nbsp;&nbsp;&nbsp;&nbsp;
 <!--{/foreach}-->
</div>
<hr>
                <p style="padding:0px;margin:0px;padding:0 5px;font-size:18px;font-weight:600;margin-top:1px;">
                    Send To:
                    <span style="padding:0px;margin:0px;font-weight:600;font-size:16px;">
                         <!--{$order.consignee}-->
                    </span>
                </p>
                <div style="padding-left:5px;margin:0px;text-align:left;">
                    <p style="padding:0px;margin:0px;font-weight:600;font-size:16px;">
                        <!--{$order.street1}-->&nbsp; <!--{$order.street2}-->
                    </p>
                    <p style="padding:0px;margin:0px;font-weight:600;font-size:16px;">
                       <!--{$order.city}-->,<!--{if $order.state}--><!--{$order.state}-->,<!--{/if}--> &nbsp;<!--{$order.zipcode}-->
                    </p>
                    <p style="padding:0px;margin:0px;font-weight:600;font-size:18px;">
                        <!--{$order.country}-->
        ...
        <!--地址标签-->
		<div style="padding:0px;margin:0px;position:relative;top:0.3cm;width:7.2cm;height:8.9cm;border:1px solid #000;font-family:arial;font-size:12px;">
            <div style="padding:0px;margin:0px;width:6.5cm;position:absolute;height:1.8cm;left:0.1cm;text-align:center;margin:0px auto;">
                <table style="padding:0px;margin:0px;border-collapse:collapse;width:100%;margin-top:0.02cm;border:0px;height:1cm;">
                    <tr style="padding:0px;margin:0px;border:0px;font-size:9px;height:0.3cm">
                        <td align="left" style="padding:0px;margin:0px;font-weight:bold;padding:2px;     border-collapse:collapse;
            ...
            <div style="padding:0px;margin:0px;width:7.2cm;position:absolute;top:1.6cm;text-align:center;margin:0px auto;">
                ...
                <table style="padding:0px;margin:0px;border-collapse:collapse;width:100%;margin-top:0cm;border:1px solid #000000;border-top:0px;height:1.5cm;">
                    <tr>
                     ...
                     <!--{foreach from =$order.goodsarr item = goods name=goodsitem}-->
<tr style="padding:0px;margin:0px;height:25px;">align
                        <td style="padding:2px;   border-right:1px solid #000;   border-collapse:collapse;
                        overflow:hidden;padding:0px;margin:0px;width:3.5cm;font-size:6pt;text-:left;">
                        ...
                        <td style="padding:2px;border-right:1px solid #000;border-collapse:collapse;overflow:hidden;padding:0px;margin:0px;width:1.5cm;font-size:6pt;text-align:center;">
		    ...
		    <!--{/foreach}-->
                    <tr>
                        ...
                        <td style="padding:2px;  border-top:1px solid #000;   border-right:1px solid #000;    border-bottom:1px solid #000;    border-collapse:collapse;overflow:hidden;padding:0px;margin:0px;width:1.3cm;font-size:6pt;text-align:center;" rowspan="2"
                        valign="top">
                            总重量
                            <br />
                            Total Weight
                        ...
                        <td style="padding:2px;    border-top:1px solid #000; border-right:1px solid #000;    border-bottom:1px solid #000;    border-collapse:collapse;overflow:hidden;padding:0px;margin:0px;width:1.5cm;font-size:6pt;text-align:center;" rowspan="2" valign="top">总价值<br /> Total Value
                            <br />
                            <br />
                        </td>
                    </tr>
