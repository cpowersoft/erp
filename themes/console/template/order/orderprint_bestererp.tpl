    ...
    <table style="border: 1px solid #000;width: 193mm;" cellpadding="0" cellspacing="0">
      <tr>
         <td width="35%"  valign="top" style="border-right:#000000 1px solid; font-size: 10px;">
            <div style="text-align:center;margin-top:10px;"><img src="common/lib/barcodegen/html/image.php?filetype=PNG&dpi=72&scale=1&rotation=0&font_family=Arial.ttf&font_size=8&text=<!--{$order.order_sn}-->&thickness=30&start=NULL&code=BCGcode128"></div><br />
