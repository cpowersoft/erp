        ...
        items: [
                ...
                items:[
						...
						blankText:'商品单位不能为空'},
                    {
						...
						mode: 'local',
						emptyText:'请选择'},
						{fieldLabel: '更多关键字',name:'productMoreKeywords1'},
                ...
                items:[
					...
					{fieldLabel: '更多关键字',name:'productMoreKeywords2'},
					{fieldLabel: '包装高度',name:'packageHeight'},
					{fieldLabel: '商品净重',name:'grossWeight'},
					{fieldLabel:'图片链接',name:'imageURLs'}
					]
            }]
        },
		{xtype:'textarea',fieldLabel: '产品标题/简述',name:'subject',width:440,height:23},
		 ...
		 buttons: [{
            ...
            handler:  function(){
						...
						setform.form.doAction('submit',{
							 url:'index.php?model=aliapi&action=save&catId=<!--{$catId}-->&catName=<!--{$catName}-->&appkey='+appkey,
							 method:'post',
