...
<script type="text/javascript" src="js/order/dedhlhandle.js"></script>
...
salechannel.push(['0','所有渠道']);
	var viewport = Ext.create('Ext.ux.depotmanagerView',{
		...
		action:user_action,
		url:'<!--{$url}-->',
		handleURL:'index.php?model=order&action=updatededhl',
		listURL:'index.php?model=order&action=Getdedhlhandle',
		windowTitle:'高级搜索',
		windowWidth:320,
		windowHeight:345,
		pagesize:15
