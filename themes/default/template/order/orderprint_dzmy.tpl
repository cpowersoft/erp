...
<div id='order_2'>        
 ...
 <!--{elseif $type eq 237}--><!--马来西亚平邮10*10-->
<!--{foreach from =$orders item = order name=orderitem key=key}-->
        ...
        <div style="border:2px solid #666;height:366px;width:370px;padding:2px;margin-top:10px;" class="pagebreak">
            ...
            <div style='height:224px;position:relative;'>
                ...
                <b style='position:absolute;top:0px;;right:4px;'> <!--{$key+1}-->/<!--{$orders|@count}--> </b>
            </div>
  ...
  <!--{elseif $type eq 238}--><!--马来西亚挂号10*10-->
<!--{foreach from =$orders item = order name=orderitem key=key}-->   
    <style> *{ margin:0; padding:0; } </style>
         ...
         <div style="border:2px solid #666;height:366px;width:370px;padding:2px;margin-top:10px;" class="pagebreak">
            ...
            <div style='height:224px;position:relative;'>
                ...
                <b style='position:absolute;top:4px;right:4px;'> <!--{$key+1}-->/<!--{$orders|@count}--> </b>
            </div>
...
<!--{/foreach}-->  
 ...
 <!--{elseif $type eq 239}--><!--中国邮政平邮小包10*10-->
<!--{foreach from =$orders item = order name=orderitem key=key}-->
         <style> *{ margin:0; padding:0; } </style>
...
<!--{elseif $type eq 240}--><!--中国邮政航空小包10*10-->
<!--{foreach from =$orders item = order name=orderitem key=key}--> 
        <style> *{ margin:0; padding:0; } </style>
         ...
         <table cellspacing='0' cellpadding='0' border='0' style='width:374px;height:374px;border:2px solid #666;margin-top:10px;' class="pagebreak">
            ...
            <tr>
                ...
                <td colspan='3' style='font-size:16px;line-height:15px;'>
                        ...
                        <!--{$order.consignee}--><br/>
                         <!--{$order.street1}--> <!--{$order.street2}--><br/>
                         <!--{$order.city}-->,<!--{$order.state}--><br/>
                         <!--{$order.country}--> &nbsp; <!--{$order.Cncountry}--></strong>
                </td>
            </tr>
            <tr style='font-size:14px;line-height:16px;'>
                <td colspan='2' style='padding-left:3px;border-bottom:2px solid #666;'>Zip:<!--{$order.zipcode}--> </td>
                <td colspan='2' style='border-bottom:2px solid #666;'>Tel:<!--{$order.tel}--></td>
            </tr>
            <tr style='font-size:14px;line-height:16px;'>
            ...
            <tr style='font-size:14px;line-height:13px;'>
                ...
                <td style='text-align:center;border-bottom:2px solid #666;'><!--{$key+1}-->/<!--{$orders|@count}--></td>
            </tr>
            <tr>
...
<!--{elseif $type eq 241}--><!--中国邮政航空小包10*10-->
<!--{foreach from =$orders item = order name=orderitem key=key}--> 
        <style> *{ margin:0; padding:0; } </style>
         ...
         <table cellspacing='0' cellpadding='0' border='0' style='width:374px;height:374px;border:2px solid #666;margin-top:10px;' class="pagebreak">
            <tr>
                <td colspan='4' style='height:36px;border-bottom:2px solid #666;'>
                    ...
                    <p style='float:left;width:106px;font-size:13px;line-height:18px;text-align:left;height:36px;padding-top:3px;'>
                        <strong>US22 <!--{$order.Cncountry}--> /</strong><br/>
                        <strong>50</strong>
                    </p>
                </td>
            </tr>
            ...
            <tr style='font-size:14px;line-height:16px;'>
                <td colspan='2' style='padding-left:3px;border-bottom:2px solid #666;'>Zip: <!--{$order.zipcode}--></td>
                <td colspan='2' style='border-bottom:2px solid #666;padding-left:50px;'>Tel: &nbsp;<!--{$order.tel}--></td>
            </tr>
            <tr style='font-size:14px;line-height:16px;'>
                <td colspan='2' style='padding-left:3px;border-bottom:2px solid #666;'>退货单位:</td>
            ...
            <tr style='font-size:14px;line-height:13px;'>
                ...
                <td style='text-align:center;border-bottom:2px solid #666;width:40px;'> <!--{$key+1}-->/<!--{$orders|@count}--></td>
            </tr>
            <tr>
                <td colspan='4' style='font-size:12px;line-height:11px;'>
                     <!--{foreach from =$order.goodsarr item = goods name=goodsitem}-->
