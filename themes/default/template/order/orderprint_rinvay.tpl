...
<!--{/foreach}-->
<!--{elseif $type eq 66}--><!--8*5-->
<!--{foreach from =$orders item = order name=orderitem}-->
<div style="font-family:Arial;width:75mm; height:100mm;" <!--{if $smarty.foreach.orderitem.last}--><!--{else}-->class="pagebreak"<!--{/if}-->>
<table style="width:75mm; height:100mm; font-size:13px" border="0" cellpadding="0" cellspacing="5">
  <tr>
    <td style="height:45mm"  valign="top">
    	<table width="100%"border="0" cellpadding="0" cellspacing="0">
        	<tr><td style="height:35mm; font-size:14px" colspan="2"  valign="top">
            	<b>Ship&nbsp;to:&nbsp;<!--{$order.consignee}--></b><br /><br/>
                <!--{$order.consignee}--><br/>
        ...
        <tr><td style="height:10mm; width:140px">
      <img src="index.php?model=login&action=Barcode&number=<!--{$order.order_sn}-->&height=35"><br/>
    <li style="font-size:10px;margin-top:-25px;letter-spacing:4px;width:160px"><center>*<!--{$order.order_sn}-->*</center></li>
            </td><td style="height:10mm; font-size:10px"><!--{$order.shipping}-->&nbsp;</li>
            </td></tr>
        </table>
    </td>
  </tr>
...
<!--{$goods.goods_price}-->&nbsp;
            ...
            <!--{/foreach}-->
        	 ...
        	 <tr style="height:25px; font-size:11px"><td>http://www.bayeagleeyes.com
...
<!--{elseif $type eq 130}--><!--8*5-->
<!--{foreach from =$orders item = order name=orderitem}-->
<div style="font-family:Arial;" <!--{if $smarty.foreach.orderitem.last}--><!--{else}-->class="pagebreak"<!--{/if}-->>
   <table border="0" cellpadding="0" cellspacing="0" style="height: 46mm; width: 78mm">
      <tr>
         <td width="40%"  valign="top" style="border-right: #000000 1px dashed;">
	            <table border="0" cellpadding="0" cellspacing="0"
	               style="width: 100%; height:auto; table-layout: fixed; overflow: scroll; word-break: break-all;margin:0px;">
	               <tr>
	                  <td><span style="float:right;font-size: 8px;font-family:Arial;"  id="length" ><!--{$smarty.foreach.orderitem.index+1}-->/<!--{$smarty.foreach.orderitem.total}-->&nbsp
                          </span><span style="float:left;font-size: 8px;font-family:Arial;"><!--{$smarty.now|date_format:'%m-%d'}--></span></td>
	               </tr>
	               <tr>
	               	  <td><span style="font-size: 8px;font-family:Arial;"><!--{$order.paypalid}--></span></td>
	               </tr>
	               <tr>
	                  <td><span style="font-size: 8px;font-family:Arial;"><!--{$order.shipping}--></span></td>
	               </tr>
	               <tr>
	                  <td><span style="font-size: 8px;font-family:Arial;">ZL:</span><span style="font-size: 8px;font-family:Arial;"> <!--{$order.weight}-->&nbsp;YF:<!--{$order.shipping_cost}-->&nbsp;</span></td>
	               </tr>
	               <tr>
	                  <td><span style="font-size: 8px;font-family:Arial;"><!--{$order.userid}--></span></td>
	               </tr>
	               ...
	               <table width="100%" border="0" cellspacing="0" cellpadding="0" style="word-break: break-all;border-top: #000000 1px dashed;">
               <tr>
                  <td>
                  	<span style="font-size: 8px;font-family:Arial;">
                        <!--{foreach from =$order.goodsarr item = goods name=goodsitem}}-->
                        <!--{$goods.location}-->:<!--{$goods.goods_qty}--> * <!--{$goods.goods_sn}--><br/>
                        <!--{/foreach}--></span>               	
                  	<span style="font-size:9px;font-weight:800;" >总共&nbsp;&nbsp;SKU,&nbsp;<!--{$order.total}-->&nbsp;个物品</span>
                  </td>
               </tr>
            </table>
         </td>
               ...
               <tr>
                  <td colspan="2">
                     <div style="font-size: 15px; font-weight: bold">
                        ...
                        <span style=" font-size: 12px;font-family:Arial;"><!--{$order.consignee}--></span><br/>
                        <span style=" font-size: 12px;font-family:Arial;"><!--{$order.street1}-->&nbsp; <!--{$order.street2}--></span><br/>
                        <span style=" font-size: 12px;font-family:Arial;"><!--{$order.city}-->&nbsp; <!--{$order.state}--></span><br/>
                        <span style=" font-size: 12px;font-family:Arial;">ZIP:&nbsp;<!--{$order.zipcode}--></span><br/>
                        <span style=" font-size: 12px;font-family:Arial;"><!--{$order.country}-->(<!--{$order.Cncountry}-->)</span><br/>
          		<span style=" font-size: 12px;font-family:Arial;">Tel:<!--{$order.tel}--></span><br/>
                     </div>
                  </td>
               </tr>
            </table>
